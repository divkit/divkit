// GENERATED BY divkit/public/json-builder/kotlin/expression-dsl-generator
 ...
 * @param param1 Number format, similar to ICU-like.
 * @return function expression
 */
...
/**
 * Returns the datetime value as timestamp in milliseconds.
 *
 * @param param0 Datetime value to convert to timestamp in milliseconds.
 * @return function expression
 */

@JvmName("getTimestampInt")
fun getTimestamp(
    param0: Expression<Long>,
): Expression<Long> =
    FunctionExpression(
 ...
 * Returns the datetime value as timestamp in milliseconds.
 *
 * @receiver Datetime value to convert to timestamp in milliseconds.
 * @return function expression
 */

@JvmName("extension_getTimestampInt")
fun Expression<Long>.getTimestamp(@Suppress("UNUSED_PARAMETER", "LocalVariableName") `do not use`: Unit = Unit) = getTimestamp(this)
