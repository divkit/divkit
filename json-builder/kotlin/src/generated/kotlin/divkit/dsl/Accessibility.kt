...
data class Accessibility internal constructor(
    ...
    data class Properties internal constructor(
        ...
        /**
         * Indicates the current state of the item. `true` is enabled, `false` is disabled.
         */
 ...
 * @param isChecked Indicates the current state of the item. `true` is enabled, `false` is disabled.
