...
class DivGrid internal constructor(
...
fun <T> TemplateContext<T>.divGrid(): LiteralProperty<DivGrid> {
    return value(DivGrid(
        accessibility = null,
        action = null,
...
fun <T> TemplateContext<T>.divGrid(
...
fun CardContext.divGrid(
    columnCount: ValueProperty<Int>,
