...
class DivGrid(BaseDiv):
    ...
    content_alignment_horizontal: typing.Optional[div_alignment_horizontal.DivAlignmentHorizontal] = Field(description='Horizontal alignment of grid contents.')
    content_alignment_vertical: typing.Optional[div_alignment_vertical.DivAlignmentVertical] = Field(description='Vertical alignment of grid contents.')
    ...
    items: typing.List[div.Div] = Field(min_items=1, description='Contents.')
