...
class DivCustom(BaseDiv):
    ...
    custom_props: typing.Optional[typing.Dict[str, typing.Any]] = Field(description='Element data for a host application.')
    custom_type: str = Field(description='Subtype of an element for a host application.')
    ...
    items: typing.Optional[typing.List[div.Div]] = Field(min_items=1, description='Nested elements.')
