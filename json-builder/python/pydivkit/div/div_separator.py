...
class DivSeparator(BaseDiv):
    ...
    delimiter_style: typing.Optional[DivSeparatorDelimiterStyle] = Field(description='Separator display settings.')
...
class DivSeparatorDelimiterStyle(BaseDiv):
    ...
    color: typing.Optional[str] = Field(format="color", description='Separator color. To prevent the separator from being displayed, set transparencyin the alpha channel. For example, `#00FFFFFF`.')
    orientation: typing.Optional[DelimiterStyleOrientation] = Field(description='Separator orientation:`vertical` — vertical;`horizontal` — horizontal.<')
