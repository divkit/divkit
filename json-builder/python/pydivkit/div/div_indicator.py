...
class DivIndicator(BaseDiv):
    ...
    active_item_color: typing.Optional[str] = Field(format="color", description='Active indicator color.')
    active_item_size: typing.Optional[float] = Field(description='A size multiplier for an active indicator.')
    ...
    animation: typing.Optional[DivIndicatorAnimation] = Field(description='Animation of switching between indicators.')
    ...
    inactive_item_color: typing.Optional[str] = Field(format="color", description='Indicator color.')
    margins: typing.Optional[div_edge_insets.DivEdgeInsets] = Field(description='External margins from the element stroke.')
    minimum_item_size: typing.Optional[float] = Field(description='A size multiplier for a minimal indicator. It is used when the required number ofindicators don\'t fit on the screen.')
    paddings: typing.Optional[div_edge_insets.DivEdgeInsets] = Field(description='Internal margins from the element stroke.')
    pager_id: typing.Optional[str] = Field(description='ID of the pager that is a data source for an indicator.')
    ...
    shape: typing.Optional[div_shape.DivShape] = Field(description='Indicator shape.')
    space_between_centers: typing.Optional[div_fixed_size.DivFixedSize] = Field(description='Spacing between indicator centers.')
