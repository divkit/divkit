...
export class DivSeparator<T extends DivSeparatorProps = DivSeparatorProps> {
    ...
    /**
     * Настройки отображения разделителя.
     */
...
export interface IDivSeparatorDelimiterStyle {
    /**
     * Цвет разделителя. Чтобы разделитель не отображался, задайте в альфа-канале прозрачность.
     * Например, `#00FFFFFF`.
     */
    color?: Type<string> | DivExpression;
    /**
     * Ориентация разделителя:`vertical` — вертикальная;`horizontal` — горизонтальная.
     */
