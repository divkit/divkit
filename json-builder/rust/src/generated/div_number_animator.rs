...
div_entity! {
    ...
    pub struct DivNumberAnimator {
        ...
        fields: {
            ...
            #[required]
            end_value: f64 => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Number, SchemaFieldType::Expr]), description: Some("The value the variable will have when the animation ends."), default_value: None, constraints: Constraints::default() },
            #[required]
            ...
            start_value: f64 => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Number, SchemaFieldType::Expr]), description: Some("The value the variable will have when the animation starts. If the property isn't specified, the current value of the variable will be used."), default_value: None, constraints: Constraints::default() },
            #[required]
