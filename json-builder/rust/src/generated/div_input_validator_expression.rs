...
div_entity! {
    ...
    pub struct DivInputValidatorExpression {
        ...
        fields: {
            ...
            #[required]
            condition: bool => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Boolean, SchemaFieldType::Expr]), description: Some("[Calculated expression](../../expressions) used as a value validity condition."), default_value: None, constraints: Constraints::default() },
            #[required]
