...
div_entity! {
    ...
    pub struct DivInput {
        ...
        fields: {
            ...
            autocapitalization: String => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Enum(vec!["auto".into(), "none".into(), "words".into(), "sentences".into(), "all_characters".into()]), SchemaFieldType::Expr]), description: Some("Text auto-capitalization type. <li>By default: `auto` — default behavior of the platform;</li><li>`none' — automatic capitalization is not applied;</li><li>`words` — capitalization of each word;</li><li>`sentences` — capitalization at the beginning of a sentence;</li><li>`all_characters' — capitalization of each character.</li>"), default_value: Some(serde_json::json!("auto")), constraints: Constraints::default() },
            ...
            enter_key_actions: Vec<DivAction> => FieldSchemaInfo { schema_type: SchemaFieldType::Array(Box::new(SchemaFieldType::Ref("DivAction".into()))), description: Some("Actions when pressing the 'Enter' key. Actions (if any) override the default behavior."), default_value: None, constraints: Constraints::default() },
            enter_key_type: String => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Enum(vec!["default".into(), "go".into(), "search".into(), "send".into(), "done".into()]), SchemaFieldType::Expr]), description: Some("'Enter' key type."), default_value: Some(serde_json::json!("default")), constraints: Constraints::default() },
            ...
            filters: Vec<DivValue> => FieldSchemaInfo { schema_type: SchemaFieldType::Array(Box::new(SchemaFieldType::AnyOf(vec![SchemaFieldType::Ref("DivInputFilterRegex".into()), SchemaFieldType::Ref("DivInputFilterExpression".into())]))), description: Some("Filter that prevents users from entering text that doesn't satisfy the specified conditions."), default_value: None, constraints: Constraints::default() },
            ...
            highlight_color: String => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::String, SchemaFieldType::Expr]), description: Some("Text highlight color. If the value isn't set, the color set in the client will be used instead."), default_value: None, constraints: Constraints { format: Some("color".into()), ..Constraints::default() } },
            hint_color: String => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::String, SchemaFieldType::Expr]), description: Some("Text color."), default_value: Some(serde_json::json!("#73000000")), constraints: Constraints { format: Some("color".into()), ..Constraints::default() } },
            hint_text: String => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::String, SchemaFieldType::Expr]), description: Some("Tooltip text."), default_value: None, constraints: Constraints::default() },
            ...
            is_enabled: bool => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Boolean, SchemaFieldType::Expr]), description: Some("Enables or disables text editing."), default_value: Some(serde_json::json!(true)), constraints: Constraints::default() },
            keyboard_type: String => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Enum(vec!["single_line_text".into(), "multi_line_text".into(), "phone".into(), "number".into(), "email".into(), "uri".into(), "password".into()]), SchemaFieldType::Expr]), description: Some("Keyboard type."), default_value: Some(serde_json::json!("multi_line_text")), constraints: Constraints::default() },
            ...
            mask: DivValue => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Ref("DivFixedLengthInputMask".into()), SchemaFieldType::Ref("DivCurrencyInputMask".into()), SchemaFieldType::Ref("DivPhoneInputMask".into())]), description: Some("Mask for entering text based on the specified template."), default_value: None, constraints: Constraints::default() },
            max_length: i64 => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Integer, SchemaFieldType::Expr]), description: Some("Maximum number of characters that can be entered in the input field."), default_value: None, constraints: Constraints { exclusive_minimum: Some(0.0), ..Constraints::default() } },
            max_visible_lines: i64 => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Integer, SchemaFieldType::Expr]), description: Some("Maximum number of lines to be displayed in the input field."), default_value: None, constraints: Constraints { exclusive_minimum: Some(0.0), ..Constraints::default() } },
            native_interface: DivInputNativeInterface => FieldSchemaInfo { schema_type: SchemaFieldType::Ref("DivInputNativeInterface".into()), description: Some("Text input line used in the native interface."), default_value: None, constraints: Constraints::default() },
            ...
            select_all_on_focus: bool => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Boolean, SchemaFieldType::Expr]), description: Some("Highlighting input text when focused."), default_value: Some(serde_json::json!(false)), constraints: Constraints::default() },
            ...
            text_alignment_vertical: String => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Enum(vec!["top".into(), "center".into(), "bottom".into(), "baseline".into()]), SchemaFieldType::Expr]), description: Some("Vertical text alignment."), default_value: Some(serde_json::json!("center")), constraints: Constraints::default() },
            ...
            #[required]
            text_variable: String => FieldSchemaInfo { schema_type: SchemaFieldType::String, description: Some("Name of text storage variable."), default_value: None, constraints: Constraints::default() },
            ...
            validators: Vec<DivValue> => FieldSchemaInfo { schema_type: SchemaFieldType::Array(Box::new(SchemaFieldType::AnyOf(vec![SchemaFieldType::Ref("DivInputValidatorRegex".into()), SchemaFieldType::Ref("DivInputValidatorExpression".into())]))), description: Some("Validator that checks that the field value meets the specified conditions."), default_value: None, constraints: Constraints::default() },
...
div_enum! {
    /// Text auto-capitalization type. By default: `auto` — default behavior of the
    /// platform;`none' — automatic capitalization is not applied;`words` —
    /// capitalization of each word;`sentences` — capitalization at the beginning of a
    /// sentence;`all_characters' — capitalization of each character.
...
div_entity! {
    ...
    pub struct DivInputNativeInterface {
        fields: {
            #[required]
            color: String => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::String, SchemaFieldType::Expr]), description: Some("Text input line color."), default_value: None, constraints: Constraints { format: Some("color".into()), ..Constraints::default() } },
        }
    }
}
