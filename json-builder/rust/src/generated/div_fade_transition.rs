...
div_entity! {
    ...
    pub struct DivFadeTransition {
        type_name: "fade",
        fields: {
            alpha: f64 => FieldSchemaInfo { schema_type: SchemaFieldType::AnyOf(vec![SchemaFieldType::Number, SchemaFieldType::Expr]), description: Some("Value of the alpha channel which the element starts appearing from or at which it finishes disappearing."), default_value: Some(serde_json::json!(0.0)), constraints: Constraints { minimum: Some(0.0), maximum: Some(1.0), ..Constraints::default() } },
