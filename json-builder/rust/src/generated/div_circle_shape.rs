...
div_entity! {
    ...
    pub struct DivCircleShape {
        ...
        fields: {
            ...
            radius: DivFixedSize => FieldSchemaInfo { schema_type: SchemaFieldType::Ref("DivFixedSize".into()), description: Some("Radius."), default_value: Some(serde_json::json!("{\"type\":\"fixed\",\"value\":10}")), constraints: Constraints::default() },
