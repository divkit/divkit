...
class EntityWithEntityPropertyTemplate @DivModelInternalApi constructor (
    ...
    constructor(
        ...
        entity = JsonTemplateParser.readOptionalField(json, "entity", topLevel, parent?.entity, EntityTemplate.CREATOR, env.logger, env)
    )
