...
import static com.yandex.div.json.TypeHelpersKt.TYPE_HELPER_STRING;
...
public class JsonParser {
    ...
    @NonNull
    public static ExpressionsList<String> readExpressionsList(
            @NonNull final JSONObject jsonObject,
            @NonNull final String key,
            @NonNull final ListValidator<String> validator,
            @NonNull final ParsingErrorLogger logger,
            @NonNull final ParsingEnvironment env,
            @NonNull final TypeHelper<String> typeHelper) {
        return readExpressionsList(jsonObject, key, doNotConvert(), validator, IS_STRING, logger, env, typeHelper);
    }
    ...
    public static ExpressionsList<String> readExpressionsList(
            ...
            @NonNull final ParsingErrorLogger logger,
            @NonNull final ParsingEnvironment env) {
        return readExpressionsList(jsonObject, key, doNotConvert(), validator, IS_STRING, logger, env, TYPE_HELPER_STRING);
    }

    @NonNull
    public static <R, T> ExpressionsList<T> readExpressionsList(
            @NonNull final JSONObject jsonObject,
            @NonNull final String key,
            @NonNull final Function1<R, T> converter,
            @NonNull final ListValidator<T> validator,
    ...
    public static <R, T> ExpressionsList<T> readExpressionsList(
            ...
            @NonNull final ParsingEnvironment env,
            @NonNull final TypeHelper<T> typeHelper) {
        ExpressionsList<T> result = readExpressionsList(
    ...
    @Nullable
    private static <R, T> ExpressionsList readExpressionsList(
            @NonNull final JSONObject jsonObject,
            @NonNull final String key,
            @NonNull final Function1<R, T> converter,
            @NonNull final ListValidator<T> validator,
        ...
        if (containsExpressions) {
            ...
            return new MutableExpressionsList<T>(key, list, validator, env.getLogger());
        } else {
            ...
            return new ConstantExpressionsList<>(list);
        }
    }
