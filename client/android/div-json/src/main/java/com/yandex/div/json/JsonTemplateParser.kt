...
import com.yandex.div.json.JsonParser.doNotConvert
import com.yandex.div.json.expressions.Expression
import com.yandex.div.json.expressions.ExpressionsList
import com.yandex.div.json.schema.Field
import com.yandex.div.json.schema.clone
...
fun <T: Any> JSONObject.writeExpressionsListField(
    key: String,
    field: Field<ExpressionsList<T>>?,
    converter: Converter<T, Any>,
) {
    when (field) {
        is Field.Value -> writeExpressionsList(key, field.value, converter)
        is Field.Reference -> write("$$key", field.reference)
        else -> Unit
    }
}
...
fun <T: Any> JSONObject.writeExpressionsListField(
    ...
    writeExpressionsListField(key, field, doNotConvert())
}
