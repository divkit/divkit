...
import static com.yandex.div.legacy.view.BaseDivViewExtensionsKt.applyStyle;

public class TabTitlesLayoutView<ACTION>
        extends YandexCoreIndicatorTabLayout
    ...
    public TabTitlesLayoutView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setTabMode(YandexCoreIndicatorTabLayout.MODE_SCROLLABLE);
    ...
    public void setData(@NonNull List<? extends BaseDivTabbedCardUi.Input.TabBase<ACTION>> dataList, int pos) {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            applyTabTitleStyle(tab.getTabView());
    ...
    private void applyTabTitleStyle(TabView tabView) {
        ...
        applyStyle(tabView, mTabTitleStyle);
    }
