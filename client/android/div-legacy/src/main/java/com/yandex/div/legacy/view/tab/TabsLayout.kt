...
import com.yandex.alicekit.core.annotations.Mockable
...
//todo Вернуть internal после переезда
@Mockable
class TabsLayout @JvmOverloads constructor(
    ...
    init {
        ...
        titleLayout =
            TabTitlesLayoutView<Any>(context, null, R.attr.legacyTabIndicatorLayoutStyle).apply {
                id = R.id.base_tabbed_title_container_scroller
                layoutParams = createTitleLayoutParams()
                val vertical =
                    resources.getDimensionPixelSize(R.dimen.title_tab_title_margin_vertical)
                val horizontal =
                    resources.getDimensionPixelSize(R.dimen.title_tab_title_margin_horizontal)
    ...
    private fun createDividerLayoutParams(): LayoutParams {
        return LayoutParams(
            ...
            topMargin =
                resources.getDimensionPixelSize(R.dimen.title_tab_title_separator_margin_top)
