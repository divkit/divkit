...
import com.yandex.alicekit.core.views.ViewPagerFixedSizeLayout.HeightCalculator;
...
public abstract class BaseDivTabbedCardUi<TAB_DATA extends BaseDivTabbedCardUi.Input.TabBase<ACTION>, TAB_VIEW, ACTION> {
    ...
    private void initializeViewPagerFixedSizeLayout() {
        ...
        mViewPagerHeightCalculator = mHeightCalculatorFactory.getCardHeightCalculator(view, this::measureTabHeight,
                                                                                      this::getTabCount);
        mViewPagerFixedSizeLayout.setHeightCalculator(mViewPagerHeightCalculator);
    }

    public void setData(@Nullable Input<TAB_DATA> data) {
        ...
        mAbstractTabBar.setData(tabs, newPos); // this also changes ViewPager position, so should go before setAdapter
    ...
    public void setTabColors(@ColorInt int activeTextColor, @ColorInt int activeBackgroundColor, @ColorInt int inactiveTextColor) {
        mAbstractTabBar.setTabColors(activeTextColor, activeBackgroundColor, inactiveTextColor);
    }
    ...
    private int measureTabHeight(@NonNull ViewGroup tabView, int width, int tabIndex) {
        ...
        if (mReuseMeasuringTabs) {
            ...
            fillMeasuringTab(tabView, tab, tabIndex);
        }
        tabView.forceLayout();
        ...
        if (!mReuseMeasuringTabs) {
            recycleMeasuringTabChildren(tabView);
        }
        return result;
    }
    ...
    public static void setTransformPageFixEnabled(boolean enabled) {
        mTransformPageFixEnabled = enabled;
    }
    ...
    public static void enableReuseMeasuringTabs(boolean enable) {
        mReuseMeasuringTabs = enable;
    }
    ...
    private class DataBindingTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(View page, float position) {
            if (mTransformPageFixEnabled && mInSetData) {
                /**
    ...
    private class Binding {
        ...
        void bind() {
            ...
            mAutoLogger.setId((View) mView, mData.getTitle());
        }
    ...
    public interface AbstractTabBar<ACTION> {
        ...
        void setTabColors(@ColorInt int activeTextColor, @ColorInt int activeBackgroundColor, @ColorInt int inactiveTextColor);
        @Nullable
