...
As an example, you can refer to our [DemoCustomContainerAdapter](https://github.com/divkit/divkit/tree/main/client/android/divkit-demo-app/src/main/java/com/yandex/divkit/demo/div/DemoCustomContainerAdapter.kt). Take note of the method `DemoCustomContainerAdapter#isCustomTypeSupported`, which specifies which custom element types can be handled by this adapter (for example, `"old_custom_card_1"` or `"new_custom_container_1"`). Once you've created your adapter, simply pass it to DivConfiguration, and your custom elements are ready to be used within your [JSON layout](https://github.com/divkit/divkit/blob/main/test_data/regression_test_data/custom-card.json).
<details>
