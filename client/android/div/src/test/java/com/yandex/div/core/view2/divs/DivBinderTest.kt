...
open class DivBinderTest {
    ...
    internal val actionBinder = mock<DivActionBinder> {
        on { bindDivActions(any(), any(), anyOrNull(), anyOrNull(), anyOrNull(), anyOrNull()) }.thenCallRealMethod()
    }
    ...
    internal val baseBinder = DivBaseBinder(imageLoader, mock(), mock(), mock(), mock())
