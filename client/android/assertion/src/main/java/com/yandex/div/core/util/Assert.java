...
import com.yandex.div.core.assertion.BuildConfig;
...
public class Assert {
    ...
    public interface AssertPerformer {
        default void performFail(@NonNull AssertionError assertionError) {
            throw assertionError;
        }
    }

    @NonNull
    private static AssertPerformer sAssertPerformer = new AssertPerformer() {
    };
    ...
    /**
     * Set custom {@link AssertPerformer} to override on fail behavior
     */
    public static void setAssertPerformer(@NonNull AssertPerformer assertPerformer) {
        sAssertPerformer = assertPerformer;
    }
    ...
    private static void performFail(@NonNull AssertionError assertionError) {
        ...
        sAssertPerformer.performFail(assertionError);
    }
}
