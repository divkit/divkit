...
class DivSliderTests {
    ...
    @Test
    fun pressStartActionsHandledOnPressStart() {
        slider {
            testAsset = "ui_test_data/slider/slider_press_actions.json"
            activityTestRule.buildContainer()
    ...
    @Test
    fun pressEndActionsHandledOnPressEnd() {
        slider {
            testAsset = "ui_test_data/slider/slider_press_actions.json"
            activityTestRule.buildContainer()
            ...
            assert { hasTextOnScreen("Released slider") }
        }
    }

    @Test
    fun pressEndActionsHandledOnPressEndInAnotherPoint() {
        slider {
            testAsset = "ui_test_data/slider/slider_press_actions.json"
            activityTestRule.buildContainer()
