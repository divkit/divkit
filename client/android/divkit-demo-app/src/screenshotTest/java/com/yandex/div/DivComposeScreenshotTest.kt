    ...
    companion object {
        ...
        fun cases(): List<Array<String>> {
            return listOf(
                ...
                "snapshot_test_data/div-text/font_feature_ranges.json",
                "snapshot_test_data/div-text/font_features.json",
                "snapshot_test_data/div-text/font_variations.json",
                ...
                "snapshot_test_data/div-container/aspect/match_parent-width.json",
                "snapshot_test_data/div-container/aspect/match_parent-width-wrap-layout_mode-vertical.json",
                "snapshot_test_data/div-container/aspect/fixed-width-wrap-layout_mode-vertical.json",
                "snapshot_test_data/div-container/aspect/wrap-layout_mode-horizontal.json",
                ...
                "snapshot_test_data/div-image/wrap-content-aspect-fractional-pixels.json",
                "snapshot_test_data/div-image/wrap-content-aspect-in-gallery-with-spacing.json",
                "snapshot_test_data/div-image/wrap-content-both-aspect-min-max-constraints.json",
                "snapshot_test_data/div-image/wrap-content-height-aspect-max-width.json",
                "snapshot_test_data/div-image/wrap-content-height-aspect-min-width.json",
                ...
                // div-gif-image
                "snapshot_test_data/div-gif-image",
                // div-gallery
