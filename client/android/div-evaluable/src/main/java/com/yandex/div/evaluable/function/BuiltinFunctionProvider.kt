...
class BuiltinFunctionProvider(
    ...
    init {
        ...
        registry.register(GetStoredUrlValueWithStringFallback(storedValueProvider))
        registry.register(GetStoredUrlValueWithUrlFallback(storedValueProvider))
        ...
        registry.register(GetDictOptColorWithColorFallback(variableProvider))
        registry.register(GetDictOptColorWithStringFallback(variableProvider))
        ...
        registry.register(GetOptColorFromDictWithColorFallback(variableProvider))
        registry.register(GetOptColorFromDictWithStringFallback(variableProvider))
