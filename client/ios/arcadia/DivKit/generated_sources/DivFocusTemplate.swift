...
public final class DivFocusTemplate: TemplateValue, TemplateDeserializable {
  public final class NextFocusIdsTemplate: TemplateValue, TemplateDeserializable {
    ...
    private static func resolveOnlyLinks(
      context: Context,
      parent: NextFocusIdsTemplate?
    ) -> DeserializationResult<DivFocus.NextFocusIds> {
      let downValue = parent?.down?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.downValidator
      ) ?? .noValue
      let forwardValue = parent?.forward?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.forwardValidator
      ) ?? .noValue
      ...
      let upValue = parent?.up?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.upValidator
      ) ?? .noValue
      let errors = mergeErrors(
        downValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "down", level: .warning)) },
        forwardValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "forward", level: .warning)) },
    ...
    public static func resolveValue(
      ...
      var forwardValue: DeserializationResult<Expression<String>> = parent?.forward?
        .value() ?? .noValue
      ...
      context.templateData.forEach { key, __dictValue in
        switch key {
        case "down":
          downValue = deserialize(__dictValue, validator: ResolvedValue.downValidator)
            .merged(with: downValue)
        case "forward":
          forwardValue = deserialize(__dictValue, validator: ResolvedValue.forwardValidator)
            .merged(with: forwardValue)
        case "left":
        ...
        case "up":
          upValue = deserialize(__dictValue, validator: ResolvedValue.upValidator)
            .merged(with: upValue)
        case parent?.down?.link:
          downValue = downValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.downValidator))
        case parent?.forward?.link:
          forwardValue = forwardValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.forwardValidator))
        ...
        case parent?.up?.link:
          upValue = upValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.upValidator))
        default: break
        }
      }
      let errors = mergeErrors(
        downValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "down", level: .warning)) },
        forwardValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "forward", level: .warning)) },
        leftValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "left", level: .warning)) },
        rightValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "right", level: .warning)) },
        upValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "up", level: .warning)) }
      )
      let result = DivFocus.NextFocusIds(
        down: downValue.value,
        forward: forwardValue.value,
    ...
    private func mergedWithParent(templates _: Templates) throws -> NextFocusIdsTemplate {
      self
    }
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    self.init(
      ...
      nextFocusIds: try dictionary.getOptionalField(
        "next_focus_ids",
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivFocusTemplate?
  ) -> DeserializationResult<DivFocus> {
    ...
    let nextFocusIdsValue = parent?.nextFocusIds?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.nextFocusIdsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let onBlurValue = parent?.onBlur?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.onBlurValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let onFocusValue = parent?.onFocus?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.onFocusValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let errors = mergeErrors(
      ...
      nextFocusIdsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "next_focus_ids", level: .warning)) },
      onBlurValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "on_blur", level: .warning)) },
      onFocusValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "on_focus", level: .warning)) }
    )
    let result = DivFocus(
  ...
  public static func resolveValue(
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "next_focus_ids":
        nextFocusIdsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.nextFocusIdsValidator,
          type: DivFocusTemplate.NextFocusIdsTemplate.self
        ).merged(with: nextFocusIdsValue)
      case "on_blur":
        onBlurValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.onBlurValidator,
          type: DivActionTemplate.self
        ).merged(with: onBlurValue)
      case "on_focus":
        onFocusValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.onFocusValidator,
          type: DivActionTemplate.self
        ).merged(with: onFocusValue)
      ...
      case parent?.nextFocusIds?.link:
        nextFocusIdsValue = nextFocusIdsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.nextFocusIdsValidator,
      ...
      case parent?.onBlur?.link:
        onBlurValue = onBlurValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.onBlurValidator,
      ...
      case parent?.onFocus?.link:
        onFocusValue = onFocusValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.onFocusValidator,
    ...
    if let parent = parent {
      ...
      nextFocusIdsValue = nextFocusIdsValue.merged(with: parent.nextFocusIds?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.nextFocusIdsValidator,
        useOnlyLinks: true
      ))
      onBlurValue = onBlurValue.merged(with: parent.onBlur?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.onBlurValidator,
        useOnlyLinks: true
      ))
      onFocusValue = onFocusValue.merged(with: parent.onFocus?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.onFocusValidator,
        useOnlyLinks: true
      ))
    ...
    let errors = mergeErrors(
      ...
      nextFocusIdsValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "next_focus_ids", level: .warning)) },
      onBlurValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "on_blur", level: .warning)) },
      onFocusValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "on_focus", level: .warning)) }
    )
    let result = DivFocus(
      background: backgroundValue.value,
      border: borderValue.value,
  ...
  private func mergedWithParent(templates _: Templates) throws -> DivFocusTemplate {
    self
  }
