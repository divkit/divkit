...
public final class DivTextTemplate: TemplateValue, TemplateDeserializable {
  public final class EllipsisTemplate: TemplateValue, TemplateDeserializable {
    ...
    private static func resolveOnlyLinks(
      context: Context,
      parent: EllipsisTemplate?
    ) -> DeserializationResult<DivText.Ellipsis> {
      let actionsValue = parent?.actions?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.actionsValidator,
        useOnlyLinks: true
      ) ?? .noValue
      let imagesValue = parent?.images?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.imagesValidator,
        useOnlyLinks: true
      ) ?? .noValue
      let rangesValue = parent?.ranges?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.rangesValidator,
        useOnlyLinks: true
      ) ?? .noValue
      let textValue = parent?.text?.resolveValue(
        context: context,
        validator: ResolvedValue.textValidator
      ) ?? .noValue
      var errors = mergeErrors(
        actionsValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "actions", level: .warning)) },
        imagesValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "images", level: .warning)) },
        rangesValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "ranges", level: .warning)) },
    ...
    public static func resolveValue(
      ...
      context.templateData.forEach { key, __dictValue in
        ...
        case "images":
          imagesValue = deserialize(
            __dictValue,
            templates: context.templates,
            templateToType: context.templateToType,
            validator: ResolvedValue.imagesValidator,
            type: DivTextTemplate.ImageTemplate.self
          ).merged(with: imagesValue)
        case "ranges":
          rangesValue = deserialize(
            __dictValue,
            templates: context.templates,
            templateToType: context.templateToType,
            validator: ResolvedValue.rangesValidator,
            type: DivTextTemplate.RangeTemplate.self
          ).merged(with: rangesValue)
        case "text":
          textValue = deserialize(__dictValue, validator: ResolvedValue.textValidator)
            .merged(with: textValue)
        ...
        case parent?.images?.link:
          imagesValue = imagesValue.merged(with: deserialize(
            __dictValue,
            templates: context.templates,
            templateToType: context.templateToType,
            validator: ResolvedValue.imagesValidator,
        ...
        case parent?.ranges?.link:
          rangesValue = rangesValue.merged(with: deserialize(
            __dictValue,
            templates: context.templates,
            templateToType: context.templateToType,
            validator: ResolvedValue.rangesValidator,
        ...
        case parent?.text?.link:
          textValue = textValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.textValidator))
        default: break
        }
      }
      if let parent = parent {
        actionsValue = actionsValue.merged(with: parent.actions?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.actionsValidator,
          useOnlyLinks: true
        ))
        imagesValue = imagesValue.merged(with: parent.images?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.imagesValidator,
          useOnlyLinks: true
        ))
        rangesValue = rangesValue.merged(with: parent.ranges?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.rangesValidator,
          useOnlyLinks: true
        ))
      ...
      var errors = mergeErrors(
        actionsValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "actions", level: .warning)) },
        imagesValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "images", level: .warning)) },
        rangesValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "ranges", level: .warning)) },
        textValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "text", level: .error)) }
      )
      if case .noValue = textValue {
        errors
          .append(.right(FieldError(
    ...
    private func mergedWithParent(templates _: Templates) throws -> EllipsisTemplate {
      self
    }
  ...
  public final class ImageTemplate: TemplateValue, TemplateDeserializable {
    ...
    public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
      do {
        self.init(
          ...
          start: try dictionary.getOptionalField("start"),
          tintColor: try dictionary.getOptionalField(
            "tint_color",
    ...
    private static func resolveOnlyLinks(
    ...
    ) -> DeserializationResult<DivText.Image> {
      let heightValue = parent?.height?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.heightValidator,
        useOnlyLinks: true
      ) ?? .noValue
      let startValue = parent?.start?.resolveValue(
        context: context,
        validator: ResolvedValue.startValidator
      ) ?? .noValue
      let tintColorValue = parent?.tintColor?.resolveOptionalValue(
        context: context,
        transform: Color.color(withHexString:),
        validator: ResolvedValue.tintColorValidator
      ) ?? .noValue
      let urlValue = parent?.url?
        .resolveValue(context: context, transform: URL.init(string:)) ?? .noValue
      ...
      var errors = mergeErrors(
        ...
        startValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "start", level: .error)) },
        tintColorValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "tint_color", level: .warning)) },
    ...
    public static func resolveValue(
      ...
      var tintColorValue: DeserializationResult<Expression<Color>> = parent?.tintColor?
        .value() ?? .noValue
      ...
      context.templateData.forEach { key, __dictValue in
        ...
        case "start":
          startValue = deserialize(__dictValue, validator: ResolvedValue.startValidator)
            .merged(with: startValue)
        case "tint_color":
          tintColorValue = deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.tintColorValidator
          ).merged(with: tintColorValue)
        case "url":
        ...
        case parent?.start?.link:
          startValue = startValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.startValidator))
        case parent?.tintColor?.link:
          tintColorValue = tintColorValue.merged(with: deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.tintColorValidator
          ))
      ...
      var errors = mergeErrors(
        ...
        startValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "start", level: .error)) },
        tintColorValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "tint_color", level: .warning)) },
        urlValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "url", level: .error)) },
        widthValue.errorsOrWarnings?
    ...
    private func mergedWithParent(templates _: Templates) throws -> ImageTemplate {
      self
    }
  ...
  public final class RangeTemplate: TemplateValue, TemplateDeserializable {
    ...
    public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
      do {
        self.init(
          actions: try dictionary.getOptionalArray("actions", templateToType: templateToType),
          end: try dictionary.getOptionalField("end"),
          fontFamily: try dictionary.getOptionalField("font_family"),
          ...
          letterSpacing: try dictionary.getOptionalField("letter_spacing"),
          lineHeight: try dictionary.getOptionalField("line_height"),
          start: try dictionary.getOptionalField("start"),
          strike: try dictionary.getOptionalField("strike"),
          textColor: try dictionary.getOptionalField(
            "text_color",
            transform: Color.color(withHexString:)
          ),
          topOffset: try dictionary.getOptionalField("top_offset"),
          underline: try dictionary.getOptionalField("underline")
        )
      } catch let DeserializationError.invalidFieldRepresentation(
        field: field,
        representation: representation
    ...
    private static func resolveOnlyLinks(
      context: Context,
      parent: RangeTemplate?
    ) -> DeserializationResult<DivText.Range> {
      let actionsValue = parent?.actions?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.actionsValidator,
        useOnlyLinks: true
      ) ?? .noValue
      let endValue = parent?.end?.resolveValue(
        context: context,
        validator: ResolvedValue.endValidator
      ) ?? .noValue
      let fontFamilyValue = parent?.fontFamily?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.fontFamilyValidator
      ) ?? .noValue
      let fontSizeValue = parent?.fontSize?.resolveOptionalValue(
        context: context,
      ...
      let letterSpacingValue = parent?.letterSpacing?
        .resolveOptionalValue(context: context) ?? .noValue
      let lineHeightValue = parent?.lineHeight?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.lineHeightValidator
      ) ?? .noValue
      let startValue = parent?.start?.resolveValue(
        context: context,
        validator: ResolvedValue.startValidator
      ) ?? .noValue
      let strikeValue = parent?.strike?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.strikeValidator
      ) ?? .noValue
      ...
      let topOffsetValue = parent?.topOffset?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.topOffsetValidator
      ) ?? .noValue
      let underlineValue = parent?.underline?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.underlineValidator
      ) ?? .noValue
      var errors = mergeErrors(
        actionsValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "actions", level: .warning)) },
        endValue.errorsOrWarnings?.map { .right($0.asError(deserializing: "end", level: .error)) },
        fontFamilyValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "font_family", level: .warning)) },
        fontSizeValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "font_size", level: .warning)) },
        ...
        letterSpacingValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "letter_spacing", level: .warning)) },
        lineHeightValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "line_height", level: .warning)) },
        startValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "start", level: .error)) },
        strikeValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "strike", level: .warning)) },
        textColorValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "text_color", level: .warning)) },
        topOffsetValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "top_offset", level: .warning)) },
        underlineValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "underline", level: .warning)) }
      )
    ...
    public static func resolveValue(
      ...
      var fontFamilyValue: DeserializationResult<Expression<DivFontFamily>> = parent?.fontFamily?
        .value() ?? .noValue
      ...
      var fontWeightValue: DeserializationResult<Expression<DivFontWeight>> = parent?.fontWeight?
        .value() ?? .noValue
      var letterSpacingValue: DeserializationResult<Expression<Double>> = parent?.letterSpacing?
        .value() ?? .noValue
      var lineHeightValue: DeserializationResult<Expression<Int>> = parent?.lineHeight?
        .value() ?? .noValue
      var startValue: DeserializationResult<Expression<Int>> = parent?.start?.value() ?? .noValue
      var strikeValue: DeserializationResult<Expression<DivLineStyle>> = parent?.strike?
        .value() ?? .noValue
      var textColorValue: DeserializationResult<Expression<Color>> = parent?.textColor?
        .value() ?? .noValue
      var topOffsetValue: DeserializationResult<Expression<Int>> = parent?.topOffset?
        .value() ?? .noValue
      var underlineValue: DeserializationResult<Expression<DivLineStyle>> = parent?.underline?
        .value() ?? .noValue
      context.templateData.forEach { key, __dictValue in
        switch key {
        case "actions":
        ...
        case "end":
          endValue = deserialize(__dictValue, validator: ResolvedValue.endValidator)
            .merged(with: endValue)
        case "font_family":
          fontFamilyValue = deserialize(__dictValue, validator: ResolvedValue.fontFamilyValidator)
            .merged(with: fontFamilyValue)
        case "font_size":
        ...
        case "line_height":
          lineHeightValue = deserialize(__dictValue, validator: ResolvedValue.lineHeightValidator)
            .merged(with: lineHeightValue)
        case "start":
          startValue = deserialize(__dictValue, validator: ResolvedValue.startValidator)
            .merged(with: startValue)
        case "strike":
          strikeValue = deserialize(__dictValue, validator: ResolvedValue.strikeValidator)
            .merged(with: strikeValue)
        case "text_color":
        ...
        case "top_offset":
          topOffsetValue = deserialize(__dictValue, validator: ResolvedValue.topOffsetValidator)
            .merged(with: topOffsetValue)
        case "underline":
          underlineValue = deserialize(__dictValue, validator: ResolvedValue.underlineValidator)
            .merged(with: underlineValue)
        case parent?.actions?.link:
          actionsValue = actionsValue.merged(with: deserialize(
            __dictValue,
            templates: context.templates,
        ...
        case parent?.end?.link:
          endValue = endValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.endValidator))
        case parent?.fontFamily?.link:
          fontFamilyValue = fontFamilyValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.fontFamilyValidator))
        ...
        case parent?.lineHeight?.link:
          lineHeightValue = lineHeightValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.lineHeightValidator))
        case parent?.start?.link:
          startValue = startValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.startValidator))
        case parent?.strike?.link:
          strikeValue = strikeValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.strikeValidator))
        ...
        case parent?.topOffset?.link:
          topOffsetValue = topOffsetValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.topOffsetValidator))
        case parent?.underline?.link:
          underlineValue = underlineValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.underlineValidator))
        default: break
        }
      }
      if let parent = parent {
      ...
      var errors = mergeErrors(
        actionsValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "actions", level: .warning)) },
        endValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "end", level: .error)) },
        fontFamilyValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "font_family", level: .warning)) },
        fontSizeValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "font_size", level: .warning)) },
        fontSizeUnitValue.errorsOrWarnings?
        ...
        letterSpacingValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "letter_spacing", level: .warning)) },
        lineHeightValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "line_height", level: .warning)) },
        startValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "start", level: .error)) },
        strikeValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "strike", level: .warning)) },
        textColorValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "text_color", level: .warning)) },
        topOffsetValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "top_offset", level: .warning)) },
        underlineValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "underline", level: .warning)) }
      )
      if case .noValue = endValue {
        errors
          .append(.right(FieldError(
    ...
    private func mergedWithParent(templates _: Templates) throws -> RangeTemplate {
      self
    }
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      self.init(
        ...
        actionAnimation: try dictionary.getOptionalField(
          "action_animation",
          templateToType: templateToType
        ),
        actions: try dictionary.getOptionalArray("actions", templateToType: templateToType),
        ...
        autoEllipsize: try dictionary.getOptionalField("auto_ellipsize"),
        ...
        doubletapActions: try dictionary.getOptionalArray(
          "doubletap_actions",
          templateToType: templateToType
        ),
        ...
        focusedTextColor: try dictionary.getOptionalField(
          "focused_text_color",
          transform: Color.color(withHexString:)
        ),
        fontFamily: try dictionary.getOptionalField("font_family"),
        ...
        letterSpacing: try dictionary.getOptionalField("letter_spacing"),
        lineHeight: try dictionary.getOptionalField("line_height"),
        longtapActions: try dictionary.getOptionalArray(
          "longtap_actions",
          templateToType: templateToType
        ),
        margins: try dictionary.getOptionalField("margins", templateToType: templateToType),
        maxLines: try dictionary.getOptionalField("max_lines"),
        minHiddenLines: try dictionary.getOptionalField("min_hidden_lines"),
        ...
        selectable: try dictionary.getOptionalField("selectable"),
        ...
        strike: try dictionary.getOptionalField("strike"),
        text: try dictionary.getOptionalField("text"),
        textAlignmentHorizontal: try dictionary.getOptionalField("text_alignment_horizontal"),
        textAlignmentVertical: try dictionary.getOptionalField("text_alignment_vertical"),
        textColor: try dictionary.getOptionalField(
          "text_color",
          transform: Color.color(withHexString:)
        ),
        textGradient: try dictionary.getOptionalField(
          "text_gradient",
          templateToType: templateToType
        ),
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivTextTemplate?
  ) -> DeserializationResult<DivText> {
    let accessibilityValue = parent?.accessibility?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.accessibilityValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let actionValue = parent?.action?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.actionValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let actionAnimationValue = parent?.actionAnimation?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.actionAnimationValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let actionsValue = parent?.actions?.resolveOptionalValue(
      context: context,
    ...
    let autoEllipsizeValue = parent?.autoEllipsize?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.autoEllipsizeValidator
    ) ?? .noValue
    ...
    let doubletapActionsValue = parent?.doubletapActions?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.doubletapActionsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let ellipsisValue = parent?.ellipsis?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.ellipsisValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    let focusedTextColorValue = parent?.focusedTextColor?.resolveOptionalValue(
      context: context,
      transform: Color.color(withHexString:),
      validator: ResolvedValue.focusedTextColorValidator
    ) ?? .noValue
    let fontFamilyValue = parent?.fontFamily?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.fontFamilyValidator
    ...
    let longtapActionsValue = parent?.longtapActions?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.longtapActionsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    let maxLinesValue = parent?.maxLines?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.maxLinesValidator
    ) ?? .noValue
    let minHiddenLinesValue = parent?.minHiddenLines?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.minHiddenLinesValidator
    ) ?? .noValue
    ...
    let selectableValue = parent?.selectable?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.selectableValidator
    ) ?? .noValue
    ...
    let textAlignmentHorizontalValue = parent?.textAlignmentHorizontal?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.textAlignmentHorizontalValidator
    ) ?? .noValue
    let textAlignmentVerticalValue = parent?.textAlignmentVertical?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.textAlignmentVerticalValidator
    ) ?? .noValue
    let textColorValue = parent?.textColor?.resolveOptionalValue(
      context: context,
      transform: Color.color(withHexString:),
    ...
    let textGradientValue = parent?.textGradient?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.textGradientValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    var errors = mergeErrors(
      ...
      actionValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "action", level: .warning)) },
      actionAnimationValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "action_animation", level: .warning)) },
      actionsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "actions", level: .warning)) },
      ...
      autoEllipsizeValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "auto_ellipsize", level: .warning)) },
      ...
      doubletapActionsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "doubletap_actions", level: .warning)) },
      ellipsisValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "ellipsis", level: .warning)) },
      ...
      focusedTextColorValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "focused_text_color", level: .warning)) },
      fontFamilyValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "font_family", level: .warning)) },
      fontSizeValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "font_size", level: .warning)) },
      ...
      lineHeightValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "line_height", level: .warning)) },
      longtapActionsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "longtap_actions", level: .warning)) },
      marginsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "margins", level: .warning)) },
      maxLinesValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "max_lines", level: .warning)) },
      minHiddenLinesValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "min_hidden_lines", level: .warning)) },
      ...
      selectableValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "selectable", level: .warning)) },
      selectedActionsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "selected_actions", level: .warning)) },
      strikeValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "strike", level: .warning)) },
      textValue.errorsOrWarnings?.map { .right($0.asError(deserializing: "text", level: .error)) },
      textAlignmentHorizontalValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "text_alignment_horizontal", level: .warning)) },
      textAlignmentVerticalValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "text_alignment_vertical", level: .warning)) },
      textColorValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "text_color", level: .warning)) },
      textGradientValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "text_gradient", level: .warning)) },
  ...
  public static func resolveValue(
    ...
    var autoEllipsizeValue: DeserializationResult<Expression<Bool>> = parent?.autoEllipsize?
      .value() ?? .noValue
    ...
    var focusedTextColorValue: DeserializationResult<Expression<Color>> = parent?.focusedTextColor?
      .value() ?? .noValue
    var fontFamilyValue: DeserializationResult<Expression<DivFontFamily>> = parent?.fontFamily?
      .value() ?? .noValue
    var fontSizeValue: DeserializationResult<Expression<Int>> = parent?.fontSize?
    ...
    var maxLinesValue: DeserializationResult<Expression<Int>> = parent?.maxLines?
      .value() ?? .noValue
    var minHiddenLinesValue: DeserializationResult<Expression<Int>> = parent?.minHiddenLines?
      .value() ?? .noValue
    var paddingsValue: DeserializationResult<DivEdgeInsets> = .noValue
    var rangesValue: DeserializationResult<[DivText.Range]> = .noValue
    var rowSpanValue: DeserializationResult<Expression<Int>> = parent?.rowSpan?.value() ?? .noValue
    var selectableValue: DeserializationResult<Expression<Bool>> = parent?.selectable?
      .value() ?? .noValue
    var selectedActionsValue: DeserializationResult<[DivAction]> = .noValue
    var strikeValue: DeserializationResult<Expression<DivLineStyle>> = parent?.strike?
      .value() ?? .noValue
    var textValue: DeserializationResult<Expression<CFString>> = parent?.text?.value() ?? .noValue
    var textAlignmentHorizontalValue: DeserializationResult<Expression<DivAlignmentHorizontal>> =
      parent?.textAlignmentHorizontal?.value() ?? .noValue
    var textAlignmentVerticalValue: DeserializationResult<Expression<DivAlignmentVertical>> =
      parent?.textAlignmentVertical?.value() ?? .noValue
    var textColorValue: DeserializationResult<Expression<Color>> = parent?.textColor?
      .value() ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "action":
        actionValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.actionValidator,
          type: DivActionTemplate.self
        ).merged(with: actionValue)
      case "action_animation":
        actionAnimationValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.actionAnimationValidator,
          type: DivAnimationTemplate.self
        ).merged(with: actionAnimationValue)
      case "actions":
        actionsValue = deserialize(
          __dictValue,
          templates: context.templates,
      ...
      case "auto_ellipsize":
        autoEllipsizeValue = deserialize(
          __dictValue,
          validator: ResolvedValue.autoEllipsizeValidator
        ).merged(with: autoEllipsizeValue)
      case "background":
      ...
      case "doubletap_actions":
        doubletapActionsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.doubletapActionsValidator,
          type: DivActionTemplate.self
        ).merged(with: doubletapActionsValue)
      case "ellipsis":
        ellipsisValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.ellipsisValidator,
          type: DivTextTemplate.EllipsisTemplate.self
        ).merged(with: ellipsisValue)
      case "extensions":
      ...
      case "focused_text_color":
        focusedTextColorValue = deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
          validator: ResolvedValue.focusedTextColorValidator
        ).merged(with: focusedTextColorValue)
      case "font_family":
        fontFamilyValue = deserialize(__dictValue, validator: ResolvedValue.fontFamilyValidator)
          .merged(with: fontFamilyValue)
      case "font_size":
        fontSizeValue = deserialize(__dictValue, validator: ResolvedValue.fontSizeValidator)
          .merged(with: fontSizeValue)
      case "font_size_unit":
        fontSizeUnitValue = deserialize(__dictValue, validator: ResolvedValue.fontSizeUnitValidator)
          .merged(with: fontSizeUnitValue)
      case "font_weight":
        fontWeightValue = deserialize(__dictValue, validator: ResolvedValue.fontWeightValidator)
          .merged(with: fontWeightValue)
      ...
      case "longtap_actions":
        longtapActionsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.longtapActionsValidator,
          type: DivActionTemplate.self
        ).merged(with: longtapActionsValue)
      case "margins":
      ...
      case "max_lines":
        maxLinesValue = deserialize(__dictValue, validator: ResolvedValue.maxLinesValidator)
          .merged(with: maxLinesValue)
      case "min_hidden_lines":
        minHiddenLinesValue = deserialize(
          __dictValue,
          validator: ResolvedValue.minHiddenLinesValidator
        ).merged(with: minHiddenLinesValue)
      case "paddings":
      ...
      case "selectable":
        selectableValue = deserialize(__dictValue, validator: ResolvedValue.selectableValidator)
          .merged(with: selectableValue)
      ...
      case "text_alignment_horizontal":
        textAlignmentHorizontalValue = deserialize(
          __dictValue,
          validator: ResolvedValue.textAlignmentHorizontalValidator
        ).merged(with: textAlignmentHorizontalValue)
      case "text_alignment_vertical":
        textAlignmentVerticalValue = deserialize(
          __dictValue,
          validator: ResolvedValue.textAlignmentVerticalValidator
        ).merged(with: textAlignmentVerticalValue)
      case "text_color":
        textColorValue = deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
      ...
      case "text_gradient":
        textGradientValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.textGradientValidator,
          type: DivGradientBackgroundTemplate.self
        ).merged(with: textGradientValue)
      case "tooltips":
      ...
      case parent?.action?.link:
        actionValue = actionValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.actionValidator,
      ...
      case parent?.actionAnimation?.link:
        actionAnimationValue = actionAnimationValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.actionAnimationValidator,
      ...
      case parent?.autoEllipsize?.link:
        autoEllipsizeValue = autoEllipsizeValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.autoEllipsizeValidator))
      ...
      case parent?.doubletapActions?.link:
        doubletapActionsValue = doubletapActionsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.doubletapActionsValidator,
      ...
      case parent?.ellipsis?.link:
        ellipsisValue = ellipsisValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.ellipsisValidator,
      ...
      case parent?.focusedTextColor?.link:
        focusedTextColorValue = focusedTextColorValue.merged(with: deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
          validator: ResolvedValue.focusedTextColorValidator
        ))
      ...
      case parent?.longtapActions?.link:
        longtapActionsValue = longtapActionsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.longtapActionsValidator,
      ...
      case parent?.maxLines?.link:
        maxLinesValue = maxLinesValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.maxLinesValidator))
      case parent?.minHiddenLines?.link:
        minHiddenLinesValue = minHiddenLinesValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.minHiddenLinesValidator))
      ...
      case parent?.selectable?.link:
        selectableValue = selectableValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.selectableValidator))
      ...
      case parent?.textAlignmentHorizontal?.link:
        textAlignmentHorizontalValue = textAlignmentHorizontalValue
          .merged(with: deserialize(
            __dictValue,
            validator: ResolvedValue.textAlignmentHorizontalValidator
          ))
      case parent?.textAlignmentVertical?.link:
        textAlignmentVerticalValue = textAlignmentVerticalValue
          .merged(with: deserialize(
            __dictValue,
            validator: ResolvedValue.textAlignmentVerticalValidator
          ))
      ...
      case parent?.textGradient?.link:
        textGradientValue = textGradientValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.textGradientValidator,
    ...
    if let parent = parent {
      ...
      actionValue = actionValue.merged(with: parent.action?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.actionValidator,
        useOnlyLinks: true
      ))
      actionAnimationValue = actionAnimationValue
        .merged(with: parent.actionAnimation?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.actionAnimationValidator,
          useOnlyLinks: true
        ))
      ...
      doubletapActionsValue = doubletapActionsValue
        .merged(with: parent.doubletapActions?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.doubletapActionsValidator,
          useOnlyLinks: true
        ))
      ellipsisValue = ellipsisValue.merged(with: parent.ellipsis?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.ellipsisValidator,
        useOnlyLinks: true
      ))
      ...
      longtapActionsValue = longtapActionsValue
        .merged(with: parent.longtapActions?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.longtapActionsValidator,
          useOnlyLinks: true
        ))
      ...
      textGradientValue = textGradientValue.merged(with: parent.textGradient?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.textGradientValidator,
        useOnlyLinks: true
      ))
    ...
    var errors = mergeErrors(
      ...
      actionValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "action", level: .warning)) },
      actionAnimationValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "action_animation", level: .warning)) },
      actionsValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "actions", level: .warning)) },
      alignmentHorizontalValue.errorsOrWarnings?
      ...
      autoEllipsizeValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "auto_ellipsize", level: .warning)) },
      backgroundValue.errorsOrWarnings?
      ...
      doubletapActionsValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "doubletap_actions", level: .warning)) },
      ellipsisValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "ellipsis", level: .warning)) },
      extensionsValue.errorsOrWarnings?
      ...
      focusedTextColorValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "focused_text_color", level: .warning)) },
      fontFamilyValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "font_family", level: .warning)) },
      fontSizeValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "font_size", level: .warning)) },
      ...
      lineHeightValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "line_height", level: .warning)) },
      longtapActionsValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "longtap_actions", level: .warning)) },
      marginsValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "margins", level: .warning)) },
      maxLinesValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "max_lines", level: .warning)) },
      minHiddenLinesValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "min_hidden_lines", level: .warning)) },
      paddingsValue.errorsOrWarnings?
      ...
      selectableValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "selectable", level: .warning)) },
      selectedActionsValue.errorsOrWarnings?
      ...
      textValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "text", level: .error)) },
      textAlignmentHorizontalValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "text_alignment_horizontal", level: .warning))
        },
      textAlignmentVerticalValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "text_alignment_vertical", level: .warning))
        },
      textColorValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "text_color", level: .warning)) },
      textGradientValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "text_gradient", level: .warning)) },
      tooltipsValue.errorsOrWarnings?
