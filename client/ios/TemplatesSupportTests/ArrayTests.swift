...
final class ArrayTests: XCTestCase {
  ...
  func test_Array_WithoutLink() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_without_link"
    )
  ...
  func test_Array_WithInternalLinks() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_internal_links"
    )
  ...
  func test_ArrayWithComplexItems_WithInternalLinks() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_complex_items_with_internal_links"
    )
  ...
  func test_ArrayWithTemplatedItems() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_templated_items"
    )
  ...
  func test_ArrayWithOverrideInItems() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_override_in_items"
    )
  ...
  func test_ArrayWithOverrideInTemplate() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_override_in_template"
    )
  ...
  func test_Array_WithLinkToInternalLink() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_link_to_internal_link"
    )
  ...
  func test_WhenArrayHasConstraintOnMinNumberOfItems_AndIsEmpty_NoValue() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_empty"
    )

    XCTAssertNil(entity)
  }

  func test_WhenArrayHasConstraintOnMinNumberOfItems_AndItemTemplatesAreInvalid_NoValue(
  ) throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_invalid_items"
    )
  ...
  func test_WhenArrayHasConstraintOnMinNumberOfItems_AndItemsInDataAreInvalid_NoValue() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_invalid_items_in_data"
    )
  ...
  func test_WhenArrayHasConstraintOnMinNumberOfItems_AndDataIsMissing_NoValue() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_missing_data"
    )
  ...
  func test_WhenArrayHasInvalidItems_SkipsThem() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_one_invalid_item"
    )
  ...
  func test_WhenArrayHasItemWithInternalLinkThatIsMissing_SkipsIt() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_missing_one_link"
    )
  ...
  func test_Array_NotTemplated() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_not_templated"
    )
  ...
  func test_HeterogeneousArray() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_heterogeneous_items"
    )

    XCTAssertEqual(entity, Expected.withHeterogeneousArray)
  }

  func test_HeterogeneousArray_WithInternalLinks() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_heterogeneous_items_with_internal_links"
    )
  ...
  func test_NestedArray() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_nested"
    )

    XCTAssertEqual(entity, Expected.withNestedArray)
  }

  func test_NestedArrayWithInternalLink() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_nested_with_internal_link"
    )
  ...
  func test_ArrayWithNestedTemplatedArray() throws {
    let entity = try readEntity(
      EntityWithArrayTemplate.self,
      fileName: "test_array_with_nested_templated_array"
    )
