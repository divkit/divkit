...
public final class EntityWithOptionalStringEnumPropertyTemplate: TemplateValue,
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: EntityWithOptionalStringEnumPropertyTemplate?
  ) -> DeserializationResult<EntityWithOptionalStringEnumProperty> {
  ...
  public static func resolveValue(
    ...
    var propertyValue: DeserializationResult<EntityWithOptionalStringEnumProperty.Property> =
      parent?.property?.value(validatedBy: ResolvedValue.propertyValidator) ?? .noValue
  ...
  private func mergedWithParent(templates: Templates) throws
    ...
    guard let parentTemplate = templates[parent] as? EntityWithOptionalStringEnumPropertyTemplate
    else {
