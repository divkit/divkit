...
public final class EntityWithComplexPropertyTemplate: TemplateValue, TemplateDeserializable {
  public final class PropertyTemplate: TemplateValue, TemplateDeserializable {
    ...
    ) -> DeserializationResult<EntityWithComplexProperty.Property> {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      ...
      throw DeserializationError.invalidFieldRepresentation(
        field: "entity_with_complex_property_template." + field,
        representation: representation
      )
    }
  }
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: EntityWithComplexPropertyTemplate?
  )
    -> DeserializationResult<EntityWithComplexProperty> {
    let propertyValue = parent?.property?
  ...
  public static func resolveValue(
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "property":
        propertyValue = deserialize(
          ...
          type: EntityWithComplexPropertyTemplate.PropertyTemplate.self
    ...
    if let parent = parent {
      propertyValue = propertyValue
        .merged(with: parent.property?.resolveValue(context: context, useOnlyLinks: true))
    }
    var errors = mergeErrors(
      propertyValue.errorsOrWarnings?
