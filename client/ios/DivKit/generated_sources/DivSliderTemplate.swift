    ...
    public static func resolveValue(context: TemplatesContext, parent: RangeTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivSlider.Range> {
      ...
      _ = {
        ...
        for (key, __dictValue) in context.templateData {
          ...
          _ = {
           if key == parent?.trackActiveStyle?.link, context.templateData["track_active_style"] == nil {
             trackActiveStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivDrawableTemplate.self).orFallback(trackActiveStyleValue)
            }
          }()
          _ = {
           if key == parent?.trackInactiveStyle?.link, context.templateData["track_inactive_style"] == nil {
             trackInactiveStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivDrawableTemplate.self).orFallback(trackInactiveStyleValue)
            }
          }()
        }
      }()
  ...
  public static func resolveValue(context: TemplatesContext, parent: DivSliderTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivSlider> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.maxValue?.link, context.templateData["max_value"] == nil {
           maxValueValue = deserialize(__dictValue).orFallback(maxValueValue)
          }
        }()
        _ = {
         if key == parent?.minValue?.link, context.templateData["min_value"] == nil {
           minValueValue = deserialize(__dictValue).orFallback(minValueValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.ranges?.link, context.templateData["ranges"] == nil {
           rangesValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivSliderTemplate.RangeTemplate.self).orFallback(rangesValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.secondaryValueAccessibility?.link, context.templateData["secondary_value_accessibility"] == nil {
           secondaryValueAccessibilityValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivAccessibilityTemplate.self).orFallback(secondaryValueAccessibilityValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.thumbSecondaryStyle?.link, context.templateData["thumb_secondary_style"] == nil {
           thumbSecondaryStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivDrawableTemplate.self).orFallback(thumbSecondaryStyleValue)
          }
        }()
        _ = {
         if key == parent?.thumbSecondaryTextStyle?.link, context.templateData["thumb_secondary_text_style"] == nil {
           thumbSecondaryTextStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivSliderTemplate.TextStyleTemplate.self).orFallback(thumbSecondaryTextStyleValue)
          }
        }()
        _ = {
         if key == parent?.thumbSecondaryValueVariable?.link, context.templateData["thumb_secondary_value_variable"] == nil {
           thumbSecondaryValueVariableValue = deserialize(__dictValue).orFallback(thumbSecondaryValueVariableValue)
          }
        }()
        _ = {
         if key == parent?.thumbStyle?.link, context.templateData["thumb_style"] == nil {
           thumbStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivDrawableTemplate.self).orFallback(thumbStyleValue)
          }
        }()
        _ = {
         if key == parent?.thumbTextStyle?.link, context.templateData["thumb_text_style"] == nil {
           thumbTextStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivSliderTemplate.TextStyleTemplate.self).orFallback(thumbTextStyleValue)
          }
        }()
        _ = {
         if key == parent?.thumbValueVariable?.link, context.templateData["thumb_value_variable"] == nil {
           thumbValueVariableValue = deserialize(__dictValue).orFallback(thumbValueVariableValue)
          }
        }()
        _ = {
         if key == parent?.tickMarkActiveStyle?.link, context.templateData["tick_mark_active_style"] == nil {
           tickMarkActiveStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivDrawableTemplate.self).orFallback(tickMarkActiveStyleValue)
          }
        }()
        _ = {
         if key == parent?.tickMarkInactiveStyle?.link, context.templateData["tick_mark_inactive_style"] == nil {
           tickMarkInactiveStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivDrawableTemplate.self).orFallback(tickMarkInactiveStyleValue)
          }
        }()
        _ = {
