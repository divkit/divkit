...
public final class DivIndicatorTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    self.init(
      ...
      activeItemColor: try dictionary.getOptionalField("active_item_color", transform: Color.color(withHexString:)),
      ...
      inactiveItemColor: try dictionary.getOptionalField("inactive_item_color", transform: Color.color(withHexString:)),
