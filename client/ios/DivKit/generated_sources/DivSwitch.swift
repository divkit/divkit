...
public final class DivSwitch: DivBase, Sendable {
  ...
  public convenience init(dictionary: [String: Any], context: ParsingContext) throws {
    self.init(
      ...
      isOnVariable: try dictionary.getField("is_on_variable", context: context),
      ...
      onColor: try dictionary.getOptionalExpressionField("on_color", transform: Color.color(withHexString:), context: context),
