...
public final class DivContainer: DivBase, Sendable {
  ...
  public convenience init(dictionary: [String: Any], context: ParsingContext) throws {
    self.init(
      ...
      lineSeparator: try dictionary.getOptionalField("line_separator", transform: { (dict: [String: Any]) in try DivContainer.Separator(dictionary: dict, context: context) }),
      lineSpacing: try dictionary.getOptionalExpressionField("line_spacing", validator: Self.lineSpacingValidator, context: context),
      ...
      separator: try dictionary.getOptionalField("separator", transform: { (dict: [String: Any]) in try DivContainer.Separator(dictionary: dict, context: context) }),
