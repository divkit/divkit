...
public final class DivSeparator: DivBase, Sendable {
  ...
  public convenience init(dictionary: [String: Any], context: ParsingContext) throws {
    self.init(
      ...
      delimiterStyle: try dictionary.getOptionalField("delimiter_style", transform: { (dict: [String: Any]) in try DivSeparator.DelimiterStyle(dictionary: dict, context: context) }),
