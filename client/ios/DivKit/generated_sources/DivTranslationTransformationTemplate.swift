      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.x?.link, context.templateData["x"] == nil {
           xValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivTranslationTemplate.self).orFallback(xValue)
          }
        }()
        _ = {
         if key == parent?.y?.link, context.templateData["y"] == nil {
           yValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivTranslationTemplate.self).orFallback(yValue)
          }
        }()
      }
    }()
