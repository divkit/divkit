...
public final class DivInputTemplate: TemplateValue, TemplateDeserializable {
  public final class NativeInterfaceTemplate: TemplateValue, TemplateDeserializable {
    ...
    public convenience init(dictionary: [String: Any], templateToType _: TemplateToType) throws {
      do {
        ...
        throw DeserializationError.invalidFieldRepresentation(
          field: "native_interface_template." + field,
          representation: representation
        )
      }
    }

    init(color: Field<Expression<Color>>? = nil) {
      self.color = color
    }

    private static func resolveOnlyLinks(
      context: Context,
      parent: NativeInterfaceTemplate?
    ) -> DeserializationResult<DivInput.NativeInterface> {
    ...
    private func mergedWithParent(templates _: Templates) throws -> NativeInterfaceTemplate {
      self
    }
  ...
  public let keyboardType: Field<Expression<KeyboardType>>? // default value: text
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      self.init(
        ...
        highlightColor: try dictionary.getOptionalField(
          "highlight_color",
          transform: Color.color(withHexString:)
        ),
        hintColor: try dictionary.getOptionalField(
          "hint_color",
          transform: Color.color(withHexString:)
        ),
        hintText: try dictionary.getOptionalField("hint_text"),
        id: try dictionary.getOptionalField("id"),
        keyboardType: try dictionary.getOptionalField("keyboard_type"),
        ...
        nativeInterface: try dictionary.getOptionalField(
          "native_interface",
          templateToType: templateToType
        ),
        ...
        selectAllOnFocus: try dictionary.getOptionalField("select_all_on_focus"),
      ...
      throw DeserializationError.invalidFieldRepresentation(
        field: "div-input_template." + field,
        representation: representation
      )
    }
  }
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivInputTemplate?
  ) -> DeserializationResult<DivInput> {
    ...
    let highlightColorValue = parent?.highlightColor?.resolveOptionalValue(
      context: context,
      transform: Color.color(withHexString:),
      validator: ResolvedValue.highlightColorValidator
    ) ?? .noValue
    let hintColorValue = parent?.hintColor?.resolveOptionalValue(
      context: context,
      transform: Color.color(withHexString:),
      validator: ResolvedValue.hintColorValidator
    ) ?? .noValue
    let hintTextValue = parent?.hintText?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.hintTextValidator
    ) ?? .noValue
    let idValue = parent?.id?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.idValidator
    ) ?? .noValue
    let keyboardTypeValue = parent?.keyboardType?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.keyboardTypeValidator
    ) ?? .noValue
    ...
    let nativeInterfaceValue = parent?.nativeInterface?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.nativeInterfaceValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    let selectAllOnFocusValue = parent?.selectAllOnFocus?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.selectAllOnFocusValidator
    ) ?? .noValue
    ...
    let textVariableValue = parent?.textVariable?.resolveValue(
      context: context,
      validator: ResolvedValue.textVariableValidator
    ) ?? .noValue
    ...
    var errors = mergeErrors(
      ...
      highlightColorValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "highlight_color", level: .warning)) },
      hintColorValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "hint_color", level: .warning)) },
      hintTextValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "hint_text", level: .warning)) },
      idValue.errorsOrWarnings?.map { .right($0.asError(deserializing: "id", level: .warning)) },
      keyboardTypeValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "keyboard_type", level: .warning)) },
      ...
      nativeInterfaceValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "native_interface", level: .warning)) },
      ...
      selectAllOnFocusValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "select_all_on_focus", level: .warning)) },
      ...
      textVariableValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "text_variable", level: .error)) },
  ...
  public static func resolveValue(
    ...
    var highlightColorValue: DeserializationResult<Expression<Color>> = parent?.highlightColor?
      .value() ?? .noValue
    var hintColorValue: DeserializationResult<Expression<Color>> = parent?.hintColor?
      .value() ?? .noValue
    var hintTextValue: DeserializationResult<Expression<String>> = parent?.hintText?
      .value() ?? .noValue
    var idValue: DeserializationResult<String> = parent?.id?
      .value(validatedBy: ResolvedValue.idValidator) ?? .noValue
    var keyboardTypeValue: DeserializationResult<Expression<DivInput.KeyboardType>> = parent?
      .keyboardType?.value() ?? .noValue
    ...
    var selectAllOnFocusValue: DeserializationResult<Expression<Bool>> = parent?.selectAllOnFocus?
      .value() ?? .noValue
    var selectedActionsValue: DeserializationResult<[DivAction]> = .noValue
    var textColorValue: DeserializationResult<Expression<Color>> = parent?.textColor?
      .value() ?? .noValue
    var textVariableValue: DeserializationResult<String> = parent?.textVariable?
      .value(validatedBy: ResolvedValue.textVariableValidator) ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "highlight_color":
        highlightColorValue = deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
          validator: ResolvedValue.highlightColorValidator
        ).merged(with: highlightColorValue)
      case "hint_color":
        hintColorValue = deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
          validator: ResolvedValue.hintColorValidator
        ).merged(with: hintColorValue)
      case "hint_text":
        hintTextValue = deserialize(__dictValue, validator: ResolvedValue.hintTextValidator)
          .merged(with: hintTextValue)
      case "id":
        idValue = deserialize(__dictValue, validator: ResolvedValue.idValidator)
          .merged(with: idValue)
      case "keyboard_type":
        keyboardTypeValue = deserialize(__dictValue, validator: ResolvedValue.keyboardTypeValidator)
          .merged(with: keyboardTypeValue)
      case "letter_spacing":
      ...
      case "native_interface":
        nativeInterfaceValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.nativeInterfaceValidator,
          type: DivInputTemplate.NativeInterfaceTemplate.self
        ).merged(with: nativeInterfaceValue)
      case "paddings":
      ...
      case "select_all_on_focus":
        selectAllOnFocusValue = deserialize(
          __dictValue,
          validator: ResolvedValue.selectAllOnFocusValidator
        ).merged(with: selectAllOnFocusValue)
      ...
      case "text_variable":
        textVariableValue = deserialize(__dictValue, validator: ResolvedValue.textVariableValidator)
          .merged(with: textVariableValue)
      case "tooltips":
      ...
      case parent?.highlightColor?.link:
        highlightColorValue = highlightColorValue.merged(with: deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
          validator: ResolvedValue.highlightColorValidator
        ))
      case parent?.hintColor?.link:
        hintColorValue = hintColorValue.merged(with: deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
          validator: ResolvedValue.hintColorValidator
        ))
      case parent?.hintText?.link:
        hintTextValue = hintTextValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.hintTextValidator))
      case parent?.id?.link:
        idValue = idValue
      ...
      case parent?.keyboardType?.link:
        keyboardTypeValue = keyboardTypeValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.keyboardTypeValidator))
      ...
      case parent?.nativeInterface?.link:
        nativeInterfaceValue = nativeInterfaceValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.nativeInterfaceValidator,
      ...
      case parent?.selectAllOnFocus?.link:
        selectAllOnFocusValue = selectAllOnFocusValue
          .merged(with: deserialize(
            __dictValue,
            validator: ResolvedValue.selectAllOnFocusValidator
          ))
      ...
      case parent?.textVariable?.link:
        textVariableValue = textVariableValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.textVariableValidator))
    ...
    if let parent = parent {
      ...
      nativeInterfaceValue = nativeInterfaceValue
        .merged(with: parent.nativeInterface?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.nativeInterfaceValidator,
          useOnlyLinks: true
        ))
    ...
    var errors = mergeErrors(
      ...
      highlightColorValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "highlight_color", level: .warning)) },
      hintColorValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "hint_color", level: .warning)) },
      hintTextValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "hint_text", level: .warning)) },
      idValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "id", level: .warning)) },
      keyboardTypeValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "keyboard_type", level: .warning)) },
      letterSpacingValue.errorsOrWarnings?
      ...
      nativeInterfaceValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "native_interface", level: .warning)) },
      paddingsValue.errorsOrWarnings?
      ...
      selectAllOnFocusValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "select_all_on_focus", level: .warning)) },
      selectedActionsValue.errorsOrWarnings?
      ...
      textVariableValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "text_variable", level: .error)) },
      tooltipsValue.errorsOrWarnings?
