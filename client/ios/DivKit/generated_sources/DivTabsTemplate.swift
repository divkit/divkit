  ...
  public final class TabTitleStyleTemplate: TemplateValue, @unchecked Sendable {
    ...
    public static func resolveValue(context: TemplatesContext, parent: TabTitleStyleTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivTabs.TabTitleStyle> {
      ...
      context.templateData.forEach { key, __dictValue in
        ...
        case "active_font_variation_settings":
        ...
        case "inactive_font_variation_settings":
        ...
        case parent?.activeFontVariationSettings?.link:
        ...
        case parent?.inactiveFontVariationSettings?.link:
