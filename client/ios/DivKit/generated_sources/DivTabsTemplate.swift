...
public final class DivTabsTemplate: TemplateValue, TemplateDeserializable {
  public final class ItemTemplate: TemplateValue, TemplateDeserializable {
    ...
    public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
      do {
        self.init(
          ...
          title: try dictionary.getOptionalField("title"),
          titleClickAction: try dictionary.getOptionalField(
            "title_click_action",
    ...
    private static func resolveOnlyLinks(
      context: Context,
      parent: ItemTemplate?
    ) -> DeserializationResult<DivTabs.Item> {
      let divValue = parent?.div?.resolveValue(context: context, useOnlyLinks: true) ?? .noValue
      let titleValue = parent?.title?.resolveValue(
        context: context,
        validator: ResolvedValue.titleValidator
      ) ?? .noValue
      let titleClickActionValue = parent?.titleClickAction?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.titleClickActionValidator,
        useOnlyLinks: true
      ) ?? .noValue
      var errors = mergeErrors(
        divValue.errorsOrWarnings?.map { .right($0.asError(deserializing: "div", level: .error)) },
        titleValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "title", level: .error)) },
        titleClickActionValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "title_click_action", level: .warning)) }
      )
    ...
    public static func resolveValue(
      ...
      context.templateData.forEach { key, __dictValue in
        ...
        case "title":
          titleValue = deserialize(__dictValue, validator: ResolvedValue.titleValidator)
            .merged(with: titleValue)
        case "title_click_action":
          titleClickActionValue = deserialize(
            __dictValue,
            templates: context.templates,
            templateToType: context.templateToType,
            validator: ResolvedValue.titleClickActionValidator,
            type: DivActionTemplate.self
          ).merged(with: titleClickActionValue)
        ...
        case parent?.title?.link:
          titleValue = titleValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.titleValidator))
        case parent?.titleClickAction?.link:
          titleClickActionValue = titleClickActionValue.merged(with: deserialize(
            __dictValue,
            templates: context.templates,
            templateToType: context.templateToType,
            validator: ResolvedValue.titleClickActionValidator,
      ...
      if let parent = parent {
        ...
        titleClickActionValue = titleClickActionValue
          .merged(with: parent.titleClickAction?.resolveOptionalValue(
            context: context,
            validator: ResolvedValue.titleClickActionValidator,
            useOnlyLinks: true
          ))
      ...
      var errors = mergeErrors(
        ...
        titleValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "title", level: .error)) },
        titleClickActionValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "title_click_action", level: .warning)) }
      )
      if case .noValue = divValue {
        errors
          .append(.right(FieldError(
    ...
    private func mergedWithParent(templates _: Templates) throws -> ItemTemplate {
      self
    }
  ...
  public final class TabTitleStyleTemplate: TemplateValue, TemplateDeserializable {
    ...
    public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
      self.init(
        activeBackgroundColor: try dictionary.getOptionalField(
          "active_background_color",
          transform: Color.color(withHexString:)
        ),
        activeFontWeight: try dictionary.getOptionalField("active_font_weight"),
        activeTextColor: try dictionary.getOptionalField(
          "active_text_color",
          transform: Color.color(withHexString:)
        ),
        animationDuration: try dictionary.getOptionalField("animation_duration"),
        animationType: try dictionary.getOptionalField("animation_type"),
        ...
        inactiveBackgroundColor: try dictionary.getOptionalField(
          "inactive_background_color",
          transform: Color.color(withHexString:)
        ),
        inactiveFontWeight: try dictionary.getOptionalField("inactive_font_weight"),
        inactiveTextColor: try dictionary.getOptionalField(
          "inactive_text_color",
          transform: Color.color(withHexString:)
        ),
        itemSpacing: try dictionary.getOptionalField("item_spacing"),
    ...
    private static func resolveOnlyLinks(
      context: Context,
      parent: TabTitleStyleTemplate?
    ) -> DeserializationResult<DivTabs.TabTitleStyle> {
      let activeBackgroundColorValue = parent?.activeBackgroundColor?.resolveOptionalValue(
        context: context,
        transform: Color.color(withHexString:),
        validator: ResolvedValue.activeBackgroundColorValidator
      ) ?? .noValue
      let activeFontWeightValue = parent?.activeFontWeight?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.activeFontWeightValidator
      ) ?? .noValue
      let activeTextColorValue = parent?.activeTextColor?.resolveOptionalValue(
        context: context,
        transform: Color.color(withHexString:),
        validator: ResolvedValue.activeTextColorValidator
      ) ?? .noValue
      let animationDurationValue = parent?.animationDuration?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.animationDurationValidator
      ) ?? .noValue
      let animationTypeValue = parent?.animationType?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.animationTypeValidator
      ) ?? .noValue
      ...
      let inactiveBackgroundColorValue = parent?.inactiveBackgroundColor?.resolveOptionalValue(
        context: context,
        transform: Color.color(withHexString:),
        validator: ResolvedValue.inactiveBackgroundColorValidator
      ) ?? .noValue
      let inactiveFontWeightValue = parent?.inactiveFontWeight?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.inactiveFontWeightValidator
      ) ?? .noValue
      let inactiveTextColorValue = parent?.inactiveTextColor?.resolveOptionalValue(
        context: context,
        transform: Color.color(withHexString:),
        validator: ResolvedValue.inactiveTextColorValidator
      ) ?? .noValue
      ...
      let errors = mergeErrors(
        activeBackgroundColorValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "active_background_color", level: .warning)) },
        activeFontWeightValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "active_font_weight", level: .warning)) },
        activeTextColorValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "active_text_color", level: .warning)) },
        animationDurationValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "animation_duration", level: .warning)) },
        animationTypeValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "animation_type", level: .warning)) },
        ...
        inactiveBackgroundColorValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "inactive_background_color", level: .warning)) },
        inactiveFontWeightValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "inactive_font_weight", level: .warning)) },
        inactiveTextColorValue.errorsOrWarnings?
          .map { .right($0.asError(deserializing: "inactive_text_color", level: .warning)) },
    ...
    public static func resolveValue(
      ...
      var activeBackgroundColorValue: DeserializationResult<Expression<Color>> = parent?
        .activeBackgroundColor?.value() ?? .noValue
      var activeFontWeightValue: DeserializationResult<Expression<DivFontWeight>> = parent?
        .activeFontWeight?.value() ?? .noValue
      var activeTextColorValue: DeserializationResult<Expression<Color>> = parent?.activeTextColor?
        .value() ?? .noValue
      var animationDurationValue: DeserializationResult<Expression<Int>> = parent?
        .animationDuration?.value() ?? .noValue
      var animationTypeValue: DeserializationResult<Expression<
        DivTabs.TabTitleStyle
          .AnimationType
      >> = parent?.animationType?.value() ?? .noValue
      ...
      var fontWeightValue: DeserializationResult<Expression<DivFontWeight>> = parent?.fontWeight?
        .value() ?? .noValue
      var inactiveBackgroundColorValue: DeserializationResult<Expression<Color>> = parent?
        .inactiveBackgroundColor?.value() ?? .noValue
      var inactiveFontWeightValue: DeserializationResult<Expression<DivFontWeight>> = parent?
        .inactiveFontWeight?.value() ?? .noValue
      var inactiveTextColorValue: DeserializationResult<Expression<Color>> = parent?
        .inactiveTextColor?.value() ?? .noValue
      var itemSpacingValue: DeserializationResult<Expression<Int>> = parent?.itemSpacing?
        .value() ?? .noValue
      ...
      context.templateData.forEach { key, __dictValue in
        ...
        case "active_background_color":
          activeBackgroundColorValue = deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.activeBackgroundColorValidator
          ).merged(with: activeBackgroundColorValue)
        case "active_font_weight":
          activeFontWeightValue = deserialize(
            __dictValue,
            validator: ResolvedValue.activeFontWeightValidator
          ).merged(with: activeFontWeightValue)
        case "active_text_color":
          activeTextColorValue = deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.activeTextColorValidator
          ).merged(with: activeTextColorValue)
        case "animation_duration":
          animationDurationValue = deserialize(
            __dictValue,
            validator: ResolvedValue.animationDurationValidator
          ).merged(with: animationDurationValue)
        case "animation_type":
          animationTypeValue = deserialize(
            __dictValue,
            validator: ResolvedValue.animationTypeValidator
          ).merged(with: animationTypeValue)
        case "corner_radius":
          cornerRadiusValue = deserialize(
            __dictValue,
            validator: ResolvedValue.cornerRadiusValidator
        ...
        case "inactive_background_color":
          inactiveBackgroundColorValue = deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.inactiveBackgroundColorValidator
          ).merged(with: inactiveBackgroundColorValue)
        case "inactive_font_weight":
          inactiveFontWeightValue = deserialize(
            __dictValue,
            validator: ResolvedValue.inactiveFontWeightValidator
          ).merged(with: inactiveFontWeightValue)
        case "inactive_text_color":
          inactiveTextColorValue = deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.inactiveTextColorValidator
          ).merged(with: inactiveTextColorValue)
        case "item_spacing":
          itemSpacingValue = deserialize(__dictValue, validator: ResolvedValue.itemSpacingValidator)
        ...
        case parent?.activeBackgroundColor?.link:
          activeBackgroundColorValue = activeBackgroundColorValue.merged(with: deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.activeBackgroundColorValidator
          ))
        ...
        case parent?.activeTextColor?.link:
          activeTextColorValue = activeTextColorValue.merged(with: deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.activeTextColorValidator
          ))
        ...
        case parent?.animationType?.link:
          animationTypeValue = animationTypeValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.animationTypeValidator))
        ...
        case parent?.inactiveBackgroundColor?.link:
          inactiveBackgroundColorValue = inactiveBackgroundColorValue.merged(with: deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.inactiveBackgroundColorValidator
          ))
        ...
        case parent?.inactiveTextColor?.link:
          inactiveTextColorValue = inactiveTextColorValue.merged(with: deserialize(
            __dictValue,
            transform: Color.color(withHexString:),
            validator: ResolvedValue.inactiveTextColorValidator
          ))
        case parent?.itemSpacing?.link:
          itemSpacingValue = itemSpacingValue
            .merged(with: deserialize(__dictValue, validator: ResolvedValue.itemSpacingValidator))
      ...
      let errors = mergeErrors(
        activeBackgroundColorValue.errorsOrWarnings?
          .map {
            Either.right($0.asError(deserializing: "active_background_color", level: .warning))
          },
        activeFontWeightValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "active_font_weight", level: .warning)) },
        activeTextColorValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "active_text_color", level: .warning)) },
        animationDurationValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "animation_duration", level: .warning)) },
        animationTypeValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "animation_type", level: .warning)) },
        cornerRadiusValue.errorsOrWarnings?
        ...
        inactiveBackgroundColorValue.errorsOrWarnings?
          .map {
            Either.right($0.asError(deserializing: "inactive_background_color", level: .warning))
          },
        inactiveFontWeightValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "inactive_font_weight", level: .warning)) },
        inactiveTextColorValue.errorsOrWarnings?
          .map { Either.right($0.asError(deserializing: "inactive_text_color", level: .warning)) },
        itemSpacingValue.errorsOrWarnings?
    ...
    private func mergedWithParent(templates _: Templates) throws -> TabTitleStyleTemplate {
      self
    }
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      self.init(
        ...
        dynamicHeight: try dictionary.getOptionalField("dynamic_height"),
        ...
        hasSeparator: try dictionary.getOptionalField("has_separator"),
        ...
        selectedTab: try dictionary.getOptionalField("selected_tab"),
        separatorColor: try dictionary.getOptionalField(
          "separator_color",
          transform: Color.color(withHexString:)
        ),
        separatorPaddings: try dictionary.getOptionalField(
          "separator_paddings",
          templateToType: templateToType
        ),
        switchTabsByContentSwipeEnabled: try dictionary
          .getOptionalField("switch_tabs_by_content_swipe_enabled"),
        tabTitleStyle: try dictionary.getOptionalField(
          "tab_title_style",
          templateToType: templateToType
        ),
        titlePaddings: try dictionary.getOptionalField(
          "title_paddings",
          templateToType: templateToType
        ),
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivTabsTemplate?
  ) -> DeserializationResult<DivTabs> {
    ...
    let dynamicHeightValue = parent?.dynamicHeight?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.dynamicHeightValidator
    ) ?? .noValue
    ...
    let hasSeparatorValue = parent?.hasSeparator?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.hasSeparatorValidator
    ) ?? .noValue
    ...
    let selectedTabValue = parent?.selectedTab?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.selectedTabValidator
    ) ?? .noValue
    let separatorColorValue = parent?.separatorColor?.resolveOptionalValue(
      context: context,
      transform: Color.color(withHexString:),
      validator: ResolvedValue.separatorColorValidator
    ) ?? .noValue
    let separatorPaddingsValue = parent?.separatorPaddings?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.separatorPaddingsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let switchTabsByContentSwipeEnabledValue = parent?.switchTabsByContentSwipeEnabled?
      .resolveOptionalValue(
        context: context,
        validator: ResolvedValue.switchTabsByContentSwipeEnabledValidator
      ) ?? .noValue
    let tabTitleStyleValue = parent?.tabTitleStyle?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.tabTitleStyleValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let titlePaddingsValue = parent?.titlePaddings?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.titlePaddingsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    var errors = mergeErrors(
      ...
      dynamicHeightValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "dynamic_height", level: .warning)) },
      ...
      hasSeparatorValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "has_separator", level: .warning)) },
      ...
      selectedTabValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "selected_tab", level: .warning)) },
      separatorColorValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "separator_color", level: .warning)) },
      separatorPaddingsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "separator_paddings", level: .warning)) },
      switchTabsByContentSwipeEnabledValue.errorsOrWarnings?
        .map {
          .right($0.asError(deserializing: "switch_tabs_by_content_swipe_enabled", level: .warning))
        },
      tabTitleStyleValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "tab_title_style", level: .warning)) },
      titlePaddingsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "title_paddings", level: .warning)) },
  ...
  public static func resolveValue(
    ...
    var columnSpanValue: DeserializationResult<Expression<Int>> = parent?.columnSpan?
      .value() ?? .noValue
    var dynamicHeightValue: DeserializationResult<Expression<Bool>> = parent?.dynamicHeight?
      .value() ?? .noValue
    var extensionsValue: DeserializationResult<[DivExtension]> = .noValue
    var focusValue: DeserializationResult<DivFocus> = .noValue
    var hasSeparatorValue: DeserializationResult<Expression<Bool>> = parent?.hasSeparator?
      .value() ?? .noValue
    ...
    var selectedTabValue: DeserializationResult<Expression<Int>> = parent?.selectedTab?
      .value() ?? .noValue
    var separatorColorValue: DeserializationResult<Expression<Color>> = parent?.separatorColor?
      .value() ?? .noValue
    var separatorPaddingsValue: DeserializationResult<DivEdgeInsets> = .noValue
    var switchTabsByContentSwipeEnabledValue: DeserializationResult<Expression<Bool>> = parent?
      .switchTabsByContentSwipeEnabled?.value() ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "dynamic_height":
        dynamicHeightValue = deserialize(
          __dictValue,
          validator: ResolvedValue.dynamicHeightValidator
        ).merged(with: dynamicHeightValue)
      case "extensions":
      ...
      case "has_separator":
        hasSeparatorValue = deserialize(__dictValue, validator: ResolvedValue.hasSeparatorValidator)
          .merged(with: hasSeparatorValue)
      case "height":
      ...
      case "items":
        itemsValue = deserialize(
          ...
          templateToType: context.templateToType,
          validator: ResolvedValue.itemsValidator,
          type: DivTabsTemplate.ItemTemplate.self
      ...
      case "selected_tab":
        selectedTabValue = deserialize(__dictValue, validator: ResolvedValue.selectedTabValidator)
          .merged(with: selectedTabValue)
      case "separator_color":
        separatorColorValue = deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
          validator: ResolvedValue.separatorColorValidator
        ).merged(with: separatorColorValue)
      case "separator_paddings":
        separatorPaddingsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.separatorPaddingsValidator,
          type: DivEdgeInsetsTemplate.self
        ).merged(with: separatorPaddingsValue)
      case "switch_tabs_by_content_swipe_enabled":
        switchTabsByContentSwipeEnabledValue = deserialize(
          __dictValue,
          validator: ResolvedValue.switchTabsByContentSwipeEnabledValidator
        ).merged(with: switchTabsByContentSwipeEnabledValue)
      case "tab_title_style":
        tabTitleStyleValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.tabTitleStyleValidator,
          type: DivTabsTemplate.TabTitleStyleTemplate.self
        ).merged(with: tabTitleStyleValue)
      case "title_paddings":
        titlePaddingsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.titlePaddingsValidator,
          type: DivEdgeInsetsTemplate.self
        ).merged(with: titlePaddingsValue)
      case "tooltips":
      ...
      case parent?.dynamicHeight?.link:
        dynamicHeightValue = dynamicHeightValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.dynamicHeightValidator))
      ...
      case parent?.hasSeparator?.link:
        hasSeparatorValue = hasSeparatorValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.hasSeparatorValidator))
      ...
      case parent?.selectedTab?.link:
        selectedTabValue = selectedTabValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.selectedTabValidator))
      case parent?.separatorColor?.link:
        separatorColorValue = separatorColorValue.merged(with: deserialize(
          __dictValue,
          transform: Color.color(withHexString:),
          validator: ResolvedValue.separatorColorValidator
        ))
      case parent?.separatorPaddings?.link:
        separatorPaddingsValue = separatorPaddingsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.separatorPaddingsValidator,
      ...
      case parent?.switchTabsByContentSwipeEnabled?.link:
        switchTabsByContentSwipeEnabledValue = switchTabsByContentSwipeEnabledValue
          .merged(with: deserialize(
            __dictValue,
            validator: ResolvedValue.switchTabsByContentSwipeEnabledValidator
          ))
      case parent?.tabTitleStyle?.link:
        tabTitleStyleValue = tabTitleStyleValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.tabTitleStyleValidator,
      ...
      case parent?.titlePaddings?.link:
        titlePaddingsValue = titlePaddingsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.titlePaddingsValidator,
    ...
    if let parent = parent {
      ...
      separatorPaddingsValue = separatorPaddingsValue
        .merged(with: parent.separatorPaddings?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.separatorPaddingsValidator,
          useOnlyLinks: true
        ))
      tabTitleStyleValue = tabTitleStyleValue
        .merged(with: parent.tabTitleStyle?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.tabTitleStyleValidator,
          useOnlyLinks: true
        ))
      titlePaddingsValue = titlePaddingsValue
        .merged(with: parent.titlePaddings?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.titlePaddingsValidator,
          useOnlyLinks: true
        ))
    ...
    var errors = mergeErrors(
      ...
      dynamicHeightValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "dynamic_height", level: .warning)) },
      extensionsValue.errorsOrWarnings?
      ...
      hasSeparatorValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "has_separator", level: .warning)) },
      heightValue.errorsOrWarnings?
      ...
      selectedTabValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "selected_tab", level: .warning)) },
      separatorColorValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "separator_color", level: .warning)) },
      separatorPaddingsValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "separator_paddings", level: .warning)) },
      switchTabsByContentSwipeEnabledValue.errorsOrWarnings?
        .map {
          Either
            .right(
              $0
                .asError(deserializing: "switch_tabs_by_content_swipe_enabled", level: .warning)
            )
        },
      tabTitleStyleValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "tab_title_style", level: .warning)) },
      titlePaddingsValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "title_paddings", level: .warning)) },
      tooltipsValue.errorsOrWarnings?
  ...
  private func mergedWithParent(templates: Templates) throws -> DivTabsTemplate {
    ...
    return DivTabsTemplate(
      ...
      switchTabsByContentSwipeEnabled: switchTabsByContentSwipeEnabled ?? mergedParent
