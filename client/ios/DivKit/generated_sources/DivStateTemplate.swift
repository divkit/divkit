    ...
    public static func resolveValue(context: TemplatesContext, parent: StateTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivState.State> {
      ...
      _ = {
        ...
        for (key, __dictValue) in context.templateData {
          ...
          _ = {
           if key == parent?.swipeOutActions?.link, context.templateData["swipe_out_actions"] == nil {
             swipeOutActionsValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivActionTemplate.self).orFallback(swipeOutActionsValue)
            }
          }()
        }
      }()
  ...
  public static func resolveValue(context: TemplatesContext, parent: DivStateTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivState> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.defaultStateId?.link, context.templateData["default_state_id"] == nil {
           defaultStateIdValue = deserialize(__dictValue).orFallback(defaultStateIdValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.divId?.link, context.templateData["div_id"] == nil {
           divIdValue = deserialize(__dictValue).orFallback(divIdValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.stateIdVariable?.link, context.templateData["state_id_variable"] == nil {
           stateIdVariableValue = deserialize(__dictValue).orFallback(stateIdVariableValue)
          }
        }()
        _ = {
         if key == parent?.states?.link, context.templateData["states"] == nil {
           statesValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, validator: ResolvedValue.statesValidator, type: DivStateTemplate.StateTemplate.self).orFallback(statesValue)
          }
        }()
        _ = {
