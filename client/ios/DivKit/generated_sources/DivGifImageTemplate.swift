  ...
  public static func resolveValue(context: TemplatesContext, parent: DivGifImageTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivGifImage> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.gifUrl?.link, context.templateData["gif_url"] == nil {
           gifUrlValue = deserialize(__dictValue, transform: URL.makeFromNonEncodedString).orFallback(gifUrlValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.previewUrl?.link, context.templateData["preview_url"] == nil {
           previewUrlValue = deserialize(__dictValue, transform: URL.makeFromNonEncodedString).orFallback(previewUrlValue)
          }
        }()
        _ = {
