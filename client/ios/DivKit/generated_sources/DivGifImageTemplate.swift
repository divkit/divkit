...
public final class DivGifImageTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      self.init(
        ...
        gifUrl: try dictionary.getOptionalField("gif_url", transform: URL.init(string:)),
      ...
      throw DeserializationError.invalidFieldRepresentation(
        field: "div-gif-image_template." + field,
        representation: representation
      )
    }
  }
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivGifImageTemplate?
  ) -> DeserializationResult<DivGifImage> {
    ...
    var errors = mergeErrors(
      ...
      gifUrlValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "gif_url", level: .error)) },
  ...
  public static func resolveValue(
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "gif_url":
        gifUrlValue = deserialize(__dictValue, transform: URL.init(string:))
          .merged(with: gifUrlValue)
      case "height":
    ...
    var errors = mergeErrors(
      ...
      gifUrlValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "gif_url", level: .error)) },
      heightValue.errorsOrWarnings?
  ...
  private func mergedWithParent(templates: Templates) throws -> DivGifImageTemplate {
  ...
  public func resolveParent(templates: Templates) throws -> DivGifImageTemplate {
