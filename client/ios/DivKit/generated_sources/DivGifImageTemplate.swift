...
public final class DivGifImageTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      ...
      throw DeserializationError.invalidFieldRepresentation(fieldName: "div-gif-image_template." + field, representation: representation)
    }
  }
  ...
  private static func resolveOnlyLinks(context: Context, parent: DivGifImageTemplate?) -> DeserializationResult<DivGifImage> {
    ...
    var errors = mergeErrors(
      ...
      gifUrlValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "gif_url", error: $0) },
    ...
    if case .noValue = gifUrlValue {
      errors.append(.requiredFieldIsMissing(fieldName: "gif_url"))
    }
    guard
