  ...
  public static func resolveValue(context: TemplatesContext, parent: DivVisibilityActionTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivVisibilityAction> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.visibilityDuration?.link, context.templateData["visibility_duration"] == nil {
           visibilityDurationValue = deserialize(__dictValue, validator: ResolvedValue.visibilityDurationValidator).orFallback(visibilityDurationValue)
          }
        }()
        _ = {
