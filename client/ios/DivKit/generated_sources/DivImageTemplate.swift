...
public final class DivImageTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      ...
      throw DeserializationError.invalidFieldRepresentation(fieldName: "div-image_template." + field, representation: representation)
    }
  }
  ...
  private static func resolveOnlyLinks(context: Context, parent: DivImageTemplate?) -> DeserializationResult<DivImage> {
    ...
    var errors = mergeErrors(
      ...
      appearanceAnimationValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "appearance_animation", error: $0) },
      aspectValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "aspect", error: $0) },
      ...
      highPriorityPreviewShowValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "high_priority_preview_show", error: $0) },
      ...
      placeholderColorValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "placeholder_color", error: $0) },
      preloadRequiredValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "preload_required", error: $0) },
      previewValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "preview", error: $0) },
