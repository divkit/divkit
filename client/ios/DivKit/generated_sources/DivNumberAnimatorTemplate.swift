...
public final class DivNumberAnimatorTemplate: TemplateValue, Sendable {
  ...
  public static func resolveValue(context: TemplatesContext, parent: DivNumberAnimatorTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivNumberAnimator> {
    if useOnlyLinks {
  ...
  private func mergedWithParent(templates: [TemplateName: Any]) throws -> DivNumberAnimatorTemplate {
    guard let parent = parent, parent != Self.type else { return self }
    guard let parentTemplate = templates[parent] as? DivNumberAnimatorTemplate else {
      throw DeserializationError.unknownType(type: parent)
    }
    let mergedParent = try parentTemplate.mergedWithParent(templates: templates)

    return DivNumberAnimatorTemplate(
      parent: nil,
  ...
  public func resolveParent(templates: [TemplateName: Any]) throws -> DivNumberAnimatorTemplate {
