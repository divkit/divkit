...
public final class DivCustomTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      ...
      throw DeserializationError.invalidFieldRepresentation(fieldName: "div-custom_template." + field, representation: representation)
    }
  }
  ...
  private static func resolveOnlyLinks(context: Context, parent: DivCustomTemplate?) -> DeserializationResult<DivCustom> {
    ...
    var errors = mergeErrors(
      ...
      customPropsValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "custom_props", error: $0) },
      customTypeValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "custom_type", error: $0) },
    ...
    if case .noValue = customTypeValue {
      errors.append(.requiredFieldIsMissing(fieldName: "custom_type"))
    }
    guard
