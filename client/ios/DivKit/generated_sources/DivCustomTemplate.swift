  ...
  public static func resolveValue(context: TemplatesContext, parent: DivCustomTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivCustom> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
          if key == "custom_props" {
           customPropsValue = deserialize(__dictValue).merged(with: customPropsValue)
          }
        }()
        _ = {
          if key == "custom_type" {
        ...
        _ = {
         if key == parent?.customProps?.link, context.templateData["custom_props"] == nil {
           customPropsValue = deserialize(__dictValue).orFallback(customPropsValue)
          }
        }()
        _ = {
         if key == parent?.customType?.link, context.templateData["custom_type"] == nil {
           customTypeValue = deserialize(__dictValue).orFallback(customTypeValue)
          }
        }()
        _ = {
