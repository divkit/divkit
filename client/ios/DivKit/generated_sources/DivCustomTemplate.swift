...
public final class DivCustomTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      ...
      throw DeserializationError.invalidFieldRepresentation(
        field: "div-custom_template." + field,
        representation: representation
      )
    }
  }
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivCustomTemplate?
  ) -> DeserializationResult<DivCustom> {
    ...
    let customPropsValue = parent?.customProps?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.customPropsValidator
    ) ?? .noValue
    ...
    var errors = mergeErrors(
      ...
      customPropsValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "custom_props", level: .warning)) },
      customTypeValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "custom_type", level: .error)) },
  ...
  public static func resolveValue(
    ...
    var columnSpanValue: DeserializationResult<Expression<Int>> = parent?.columnSpan?
      .value() ?? .noValue
    var customPropsValue: DeserializationResult<[String: Any]> = parent?.customProps?
      .value(validatedBy: ResolvedValue.customPropsValidator) ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "custom_props":
        customPropsValue = deserialize(__dictValue, validator: ResolvedValue.customPropsValidator)
          .merged(with: customPropsValue)
      case "custom_type":
      ...
      case parent?.customProps?.link:
        customPropsValue = customPropsValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.customPropsValidator))
    ...
    var errors = mergeErrors(
      ...
      customPropsValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "custom_props", level: .warning)) },
      customTypeValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "custom_type", level: .error)) },
      extensionsValue.errorsOrWarnings?
