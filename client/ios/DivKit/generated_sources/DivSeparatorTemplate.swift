  ...
  public static func resolveValue(context: TemplatesContext, parent: DivSeparatorTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivSeparator> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.delimiterStyle?.link, context.templateData["delimiter_style"] == nil {
           delimiterStyleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivSeparatorTemplate.DelimiterStyleTemplate.self).orFallback(delimiterStyleValue)
          }
        }()
        _ = {
