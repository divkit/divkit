...
public final class DivSeparatorTemplate: TemplateValue, TemplateDeserializable {
  public final class DelimiterStyleTemplate: TemplateValue, TemplateDeserializable {
    ...
    private static func resolveOnlyLinks(
      context: Context,
      parent: DelimiterStyleTemplate?
    ) -> DeserializationResult<DivSeparator.DelimiterStyle> {
    ...
    public static func resolveValue(
      ...
      var orientationValue: DeserializationResult<Expression<
        DivSeparator.DelimiterStyle
          .Orientation
      >> = parent?.orientation?.value() ?? .noValue
    ...
    private func mergedWithParent(templates _: Templates) throws -> DelimiterStyleTemplate {
      self
    }
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    self.init(
      ...
      delimiterStyle: try dictionary.getOptionalField(
        "delimiter_style",
        templateToType: templateToType
      ),
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivSeparatorTemplate?
  ) -> DeserializationResult<DivSeparator> {
    ...
    let delimiterStyleValue = parent?.delimiterStyle?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.delimiterStyleValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    let errors = mergeErrors(
      ...
      delimiterStyleValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "delimiter_style", level: .warning)) },
  ...
  public static func resolveValue(
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "delimiter_style":
        delimiterStyleValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.delimiterStyleValidator,
          type: DivSeparatorTemplate.DelimiterStyleTemplate.self
        ).merged(with: delimiterStyleValue)
      ...
      case parent?.delimiterStyle?.link:
        delimiterStyleValue = delimiterStyleValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.delimiterStyleValidator,
    ...
    if let parent = parent {
      ...
      delimiterStyleValue = delimiterStyleValue
        .merged(with: parent.delimiterStyle?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.delimiterStyleValidator,
          useOnlyLinks: true
        ))
    ...
    let errors = mergeErrors(
      ...
      delimiterStyleValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "delimiter_style", level: .warning)) },
      doubletapActionsValue.errorsOrWarnings?
