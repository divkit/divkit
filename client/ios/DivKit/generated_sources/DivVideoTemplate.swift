...
public final class DivVideoTemplate: TemplateValue {
  ...
  public let height: Field<DivSizeTemplate>? // default value:
  ...
  public let width: Field<DivSizeTemplate>? // default value:
  ...
  public convenience init(
    ...
    do {
      self.init(
        ...
        bufferingActions: try dictionary.getOptionalArray(
          "buffering_actions",
          templateToType: templateToType
        ),
        columnSpan: try dictionary.getOptionalExpressionField("column_span"),
        disappearActions: try dictionary.getOptionalArray(
          "disappear_actions",
          templateToType: templateToType
        ),
        ...
        fatalActions: try dictionary.getOptionalArray(
          "fatal_actions",
          templateToType: templateToType
        ),
        ...
        pauseActions: try dictionary.getOptionalArray(
          "pause_actions",
          templateToType: templateToType
        ),
        ...
        resumeActions: try dictionary.getOptionalArray(
          "resume_actions",
          templateToType: templateToType
        ),
        ...
        videoSources: try dictionary.getOptionalArray(
          "video_sources",
          templateToType: templateToType
        ),
      ...
      throw DeserializationError.invalidFieldRepresentation(
        field: "div-video_template." + field,
        representation: representation
      )
    }
  }
  ...
  private static func resolveOnlyLinks(
    ...
    parent: DivVideoTemplate?
  ) -> DeserializationResult<DivVideo> {
    ...
    let aspectValue = parent?.aspect?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.aspectValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let autostartValue = parent?.autostart?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.autostartValidator
    ) ?? .noValue
    ...
    let bufferingActionsValue = parent?.bufferingActions?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.bufferingActionsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    let disappearActionsValue = parent?.disappearActions?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.disappearActionsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let elapsedTimeVariableValue = parent?.elapsedTimeVariable?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.elapsedTimeVariableValidator
    ) ?? .noValue
    let endActionsValue = parent?.endActions?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.endActionsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    let fatalActionsValue = parent?.fatalActions?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.fatalActionsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    let mutedValue = parent?.muted?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.mutedValidator
    ) ?? .noValue
    ...
    let pauseActionsValue = parent?.pauseActions?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.pauseActionsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    let playerSettingsPayloadValue = parent?.playerSettingsPayload?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.playerSettingsPayloadValidator
    ) ?? .noValue
    let previewValue = parent?.preview?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.previewValidator
    ) ?? .noValue
    let repeatableValue = parent?.repeatable?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.repeatableValidator
    ) ?? .noValue
    let resumeActionsValue = parent?.resumeActions?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.resumeActionsValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    let videoSourcesValue = parent?.videoSources?.resolveValue(
      context: context,
      validator: ResolvedValue.videoSourcesValidator,
      useOnlyLinks: true
    ) ?? .noValue
    ...
    var errors = mergeErrors(
      accessibilityValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "accessibility", error: $0) },
      alignmentHorizontalValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "alignment_horizontal", error: $0) },
      alignmentVerticalValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "alignment_vertical", error: $0) },
      ...
      bufferingActionsValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "buffering_actions", error: $0) },
      columnSpanValue.errorsOrWarnings?.map { .nestedObjectError(field: "column_span", error: $0) },
      disappearActionsValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "disappear_actions", error: $0) },
      elapsedTimeVariableValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "elapsed_time_variable", error: $0) },
      endActionsValue.errorsOrWarnings?.map { .nestedObjectError(field: "end_actions", error: $0) },
      extensionsValue.errorsOrWarnings?.map { .nestedObjectError(field: "extensions", error: $0) },
      fatalActionsValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "fatal_actions", error: $0) },
      ...
      pauseActionsValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "pause_actions", error: $0) },
      playerSettingsPayloadValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "player_settings_payload", error: $0) },
      ...
      resumeActionsValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "resume_actions", error: $0) },
      rowSpanValue.errorsOrWarnings?.map { .nestedObjectError(field: "row_span", error: $0) },
      selectedActionsValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "selected_actions", error: $0) },
      tooltipsValue.errorsOrWarnings?.map { .nestedObjectError(field: "tooltips", error: $0) },
      transformValue.errorsOrWarnings?.map { .nestedObjectError(field: "transform", error: $0) },
      transitionChangeValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "transition_change", error: $0) },
      transitionInValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "transition_in", error: $0) },
      transitionOutValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "transition_out", error: $0) },
      transitionTriggersValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "transition_triggers", error: $0) },
      videoSourcesValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "video_sources", error: $0) },
      visibilityValue.errorsOrWarnings?.map { .nestedObjectError(field: "visibility", error: $0) },
      visibilityActionValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "visibility_action", error: $0) },
      visibilityActionsValue.errorsOrWarnings?
        .map { .nestedObjectError(field: "visibility_actions", error: $0) },
  ...
  public static func resolveValue(
    ...
    var autostartValue: DeserializationResult<Expression<Bool>> = parent?.autostart?
      .value() ?? .noValue
    ...
    var elapsedTimeVariableValue: DeserializationResult<String> = parent?.elapsedTimeVariable?
      .value(validatedBy: ResolvedValue.elapsedTimeVariableValidator) ?? .noValue
    ...
    var playerSettingsPayloadValue: DeserializationResult<[String: Any]> = parent?
      .playerSettingsPayload?
      .value(validatedBy: ResolvedValue.playerSettingsPayloadValidator) ?? .noValue
    var previewValue: DeserializationResult<Expression<String>> = parent?.preview?
      .value() ?? .noValue
    var repeatableValue: DeserializationResult<Expression<Bool>> = parent?.repeatable?
      .value() ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "aspect":
        aspectValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.aspectValidator,
          type: DivAspectTemplate.self
        ).merged(with: aspectValue)
      case "autostart":
        autostartValue = deserialize(__dictValue, validator: ResolvedValue.autostartValidator)
          .merged(with: autostartValue)
      case "background":
      ...
      case "buffering_actions":
        bufferingActionsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.bufferingActionsValidator,
          type: DivActionTemplate.self
        ).merged(with: bufferingActionsValue)
      case "column_span":
      ...
      case "disappear_actions":
        disappearActionsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.disappearActionsValidator,
          type: DivDisappearActionTemplate.self
        ).merged(with: disappearActionsValue)
      case "elapsed_time_variable":
        elapsedTimeVariableValue = deserialize(
          __dictValue,
          validator: ResolvedValue.elapsedTimeVariableValidator
        ).merged(with: elapsedTimeVariableValue)
      case "end_actions":
        endActionsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.endActionsValidator,
          type: DivActionTemplate.self
        ).merged(with: endActionsValue)
      case "extensions":
      ...
      case "fatal_actions":
        fatalActionsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.fatalActionsValidator,
          type: DivActionTemplate.self
        ).merged(with: fatalActionsValue)
      case "focus":
      ...
      case "muted":
        mutedValue = deserialize(__dictValue, validator: ResolvedValue.mutedValidator)
          .merged(with: mutedValue)
      case "paddings":
      ...
      case "pause_actions":
        pauseActionsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.pauseActionsValidator,
          type: DivActionTemplate.self
        ).merged(with: pauseActionsValue)
      case "player_settings_payload":
        playerSettingsPayloadValue = deserialize(
          __dictValue,
          validator: ResolvedValue.playerSettingsPayloadValidator
        ).merged(with: playerSettingsPayloadValue)
      case "preview":
        previewValue = deserialize(__dictValue, validator: ResolvedValue.previewValidator)
          .merged(with: previewValue)
      case "repeatable":
        repeatableValue = deserialize(__dictValue, validator: ResolvedValue.repeatableValidator)
          .merged(with: repeatableValue)
      case "resume_actions":
        resumeActionsValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.resumeActionsValidator,
          type: DivActionTemplate.self
        ).merged(with: resumeActionsValue)
      case "row_span":
      ...
      case "video_sources":
        videoSourcesValue = deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.videoSourcesValidator,
          type: DivVideoSourceTemplate.self
        ).merged(with: videoSourcesValue)
      case "visibility":
      ...
      case parent?.aspect?.link:
        aspectValue = aspectValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.aspectValidator,
      ...
      case parent?.autostart?.link:
        autostartValue = autostartValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.autostartValidator))
      ...
      case parent?.bufferingActions?.link:
        bufferingActionsValue = bufferingActionsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.bufferingActionsValidator,
      ...
      case parent?.disappearActions?.link:
        disappearActionsValue = disappearActionsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.disappearActionsValidator,
      ...
      case parent?.elapsedTimeVariable?.link:
        elapsedTimeVariableValue = elapsedTimeVariableValue
          .merged(with: deserialize(
            __dictValue,
            validator: ResolvedValue.elapsedTimeVariableValidator
          ))
      case parent?.endActions?.link:
        endActionsValue = endActionsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.endActionsValidator,
      ...
      case parent?.fatalActions?.link:
        fatalActionsValue = fatalActionsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.fatalActionsValidator,
      ...
      case parent?.muted?.link:
        mutedValue = mutedValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.mutedValidator))
      ...
      case parent?.pauseActions?.link:
        pauseActionsValue = pauseActionsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.pauseActionsValidator,
      ...
      case parent?.playerSettingsPayload?.link:
        playerSettingsPayloadValue = playerSettingsPayloadValue
          .merged(with: deserialize(
            __dictValue,
            validator: ResolvedValue.playerSettingsPayloadValidator
          ))
      case parent?.preview?.link:
        previewValue = previewValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.previewValidator))
      case parent?.repeatable?.link:
        repeatableValue = repeatableValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.repeatableValidator))
      case parent?.resumeActions?.link:
        resumeActionsValue = resumeActionsValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.resumeActionsValidator,
      ...
      case parent?.videoSources?.link:
        videoSourcesValue = videoSourcesValue.merged(with: deserialize(
          __dictValue,
          templates: context.templates,
          templateToType: context.templateToType,
          validator: ResolvedValue.videoSourcesValidator,
    ...
    if let parent = parent {
      ...
      aspectValue = aspectValue.merged(with: parent.aspect?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.aspectValidator,
        useOnlyLinks: true
      ))
      ...
      bufferingActionsValue = bufferingActionsValue
        .merged(with: parent.bufferingActions?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.bufferingActionsValidator,
          useOnlyLinks: true
        ))
      disappearActionsValue = disappearActionsValue
        .merged(with: parent.disappearActions?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.disappearActionsValidator,
          useOnlyLinks: true
        ))
      endActionsValue = endActionsValue.merged(with: parent.endActions?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.endActionsValidator,
        useOnlyLinks: true
      ))
      ...
      fatalActionsValue = fatalActionsValue.merged(with: parent.fatalActions?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.fatalActionsValidator,
        useOnlyLinks: true
      ))
      ...
      pauseActionsValue = pauseActionsValue.merged(with: parent.pauseActions?.resolveOptionalValue(
        context: context,
        validator: ResolvedValue.pauseActionsValidator,
        useOnlyLinks: true
      ))
      resumeActionsValue = resumeActionsValue
        .merged(with: parent.resumeActions?.resolveOptionalValue(
          context: context,
          validator: ResolvedValue.resumeActionsValidator,
          useOnlyLinks: true
        ))
      ...
      videoSourcesValue = videoSourcesValue.merged(with: parent.videoSources?.resolveValue(
        context: context,
        validator: ResolvedValue.videoSourcesValidator,
        useOnlyLinks: true
      ))
