...
public final class DivGridTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      self.init(
        ...
        columnCount: try dictionary.getOptionalField("column_count"),
        ...
        items: try dictionary.getOptionalArray(
          "items",
          templateToType: templateToType,
          validator: Self.itemsValidator
        ),
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivGridTemplate?
  ) -> DeserializationResult<DivGrid> {
    ...
    let columnCountValue = parent?.columnCount?.resolveValue(
      context: context,
      validator: ResolvedValue.columnCountValidator
    ) ?? .noValue
    ...
    var errors = mergeErrors(
      ...
      columnCountValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "column_count", level: .error)) },
  ...
  public static func resolveValue(
    ...
    var columnCountValue: DeserializationResult<Expression<Int>> = parent?.columnCount?
      .value() ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "column_count":
        columnCountValue = deserialize(__dictValue, validator: ResolvedValue.columnCountValidator)
          .merged(with: columnCountValue)
      case "column_span":
      ...
      case parent?.columnCount?.link:
        columnCountValue = columnCountValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.columnCountValidator))
    ...
    var errors = mergeErrors(
      ...
      columnCountValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "column_count", level: .error)) },
      columnSpanValue.errorsOrWarnings?
