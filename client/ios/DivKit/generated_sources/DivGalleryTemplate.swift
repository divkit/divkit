...
public final class DivGalleryTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      self.init(
        ...
        crossContentAlignment: try dictionary.getOptionalField("cross_content_alignment"),
        defaultItem: try dictionary.getOptionalField("default_item"),
        ...
        scrollMode: try dictionary.getOptionalField("scroll_mode"),
      ...
      throw DeserializationError.invalidFieldRepresentation(
        field: "div-gallery_template." + field,
        representation: representation
      )
    }
  }
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivGalleryTemplate?
  ) -> DeserializationResult<DivGallery> {
    ...
    let columnCountValue = parent?.columnCount?.resolveOptionalValue(
      context: context,
    ...
    let crossContentAlignmentValue = parent?.crossContentAlignment?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.crossContentAlignmentValidator
    ) ?? .noValue
    ...
    let scrollModeValue = parent?.scrollMode?.resolveOptionalValue(
      context: context,
      validator: ResolvedValue.scrollModeValidator
    ) ?? .noValue
    ...
    var errors = mergeErrors(
      ...
      columnCountValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "column_count", level: .warning)) },
      columnSpanValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "column_span", level: .warning)) },
      crossContentAlignmentValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "cross_content_alignment", level: .warning)) },
      ...
      scrollModeValue.errorsOrWarnings?
        .map { .right($0.asError(deserializing: "scroll_mode", level: .warning)) },
  ...
  public static func resolveValue(
    ...
    var columnSpanValue: DeserializationResult<Expression<Int>> = parent?.columnSpan?
      .value() ?? .noValue
    var crossContentAlignmentValue: DeserializationResult<Expression<
      DivGallery
        .CrossContentAlignment
    >> = parent?.crossContentAlignment?.value() ?? .noValue
    ...
    var orientationValue: DeserializationResult<Expression<DivGallery.Orientation>> = parent?
    ...
    var scrollModeValue: DeserializationResult<Expression<DivGallery.ScrollMode>> = parent?
      .scrollMode?.value() ?? .noValue
    ...
    context.templateData.forEach { key, __dictValue in
      ...
      case "cross_content_alignment":
        crossContentAlignmentValue = deserialize(
          __dictValue,
          validator: ResolvedValue.crossContentAlignmentValidator
        ).merged(with: crossContentAlignmentValue)
      case "default_item":
      ...
      case "scroll_mode":
        scrollModeValue = deserialize(__dictValue, validator: ResolvedValue.scrollModeValidator)
          .merged(with: scrollModeValue)
      ...
      case parent?.crossContentAlignment?.link:
        crossContentAlignmentValue = crossContentAlignmentValue
          .merged(with: deserialize(
            __dictValue,
            validator: ResolvedValue.crossContentAlignmentValidator
          ))
      ...
      case parent?.scrollMode?.link:
        scrollModeValue = scrollModeValue
          .merged(with: deserialize(__dictValue, validator: ResolvedValue.scrollModeValidator))
    ...
    var errors = mergeErrors(
      ...
      columnCountValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "column_count", level: .warning)) },
      columnSpanValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "column_span", level: .warning)) },
      crossContentAlignmentValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "cross_content_alignment", level: .warning))
        },
      defaultItemValue.errorsOrWarnings?
      ...
      scrollModeValue.errorsOrWarnings?
        .map { Either.right($0.asError(deserializing: "scroll_mode", level: .warning)) },
      selectedActionsValue.errorsOrWarnings?
  ...
  private func mergedWithParent(templates: Templates) throws -> DivGalleryTemplate {
  ...
  public func resolveParent(templates: Templates) throws -> DivGalleryTemplate {
