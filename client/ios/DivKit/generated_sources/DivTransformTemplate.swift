...
public final class DivTransformTemplate: TemplateValue, Sendable {
  ...
  public static func resolveValue(context: TemplatesContext, parent: DivTransformTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivTransform> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.rotation?.link, context.templateData["rotation"] == nil {
           rotationValue = deserialize(__dictValue).orFallback(rotationValue)
          }
        }()
      }
    }()
