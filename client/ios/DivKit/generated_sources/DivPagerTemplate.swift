...
public final class DivPagerTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      ...
      throw DeserializationError.invalidFieldRepresentation(fieldName: "div-pager_template." + field, representation: representation)
    }
  }
  ...
  private static func resolveOnlyLinks(context: Context, parent: DivPagerTemplate?) -> DeserializationResult<DivPager> {
    ...
    if case .noValue = layoutModeValue {
      errors.append(.requiredFieldIsMissing(fieldName: "layout_mode"))
    }
    guard
