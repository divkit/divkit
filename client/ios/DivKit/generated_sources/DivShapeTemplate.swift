...
public enum DivShapeTemplate: TemplateValue {
  ...
  public static func resolveValue(
    context: Context,
    parent: DivShapeTemplate?,
    useOnlyLinks: Bool
  ) -> DeserializationResult<DivShape> {
    ...
    case let .divRoundedRectangleShapeTemplate(value):
      ...
      case let .partialSuccess(
        value,
        warnings
      ): return .partialSuccess(.divRoundedRectangleShape(value), warnings: warnings)
  ...
  private static func resolveUnknownValue(
    ...
    case DivRoundedRectangleShape.type:
      let result = DivRoundedRectangleShapeTemplate.resolveValue(
        context: context,
...
extension DivShapeTemplate: TemplateDeserializable {
  public init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    ...
    case DivRoundedRectangleShapeTemplate.type:
      self =
        .divRoundedRectangleShapeTemplate(
          try DivRoundedRectangleShapeTemplate(
