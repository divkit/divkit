...
public final class DivContainerTemplate: TemplateValue, TemplateDeserializable {
  public final class SeparatorTemplate: TemplateValue, TemplateDeserializable {
    ...
    public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
      do {
        ...
        throw DeserializationError.invalidFieldRepresentation(fieldName: "separator_template." + field, representation: representation)
      }
    }
    ...
    private static func resolveOnlyLinks(context: Context, parent: SeparatorTemplate?) -> DeserializationResult<DivContainer.Separator> {
      ...
      var errors = mergeErrors(
        showAtEndValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "show_at_end", error: $0) },
        showAtStartValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "show_at_start", error: $0) },
        showBetweenValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "show_between", error: $0) },
        styleValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "style", error: $0) }
      )
      if case .noValue = styleValue {
        errors.append(.requiredFieldIsMissing(fieldName: "style"))
      }
      guard
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      ...
      throw DeserializationError.invalidFieldRepresentation(fieldName: "div-container_template." + field, representation: representation)
    }
  }
  ...
  private static func resolveOnlyLinks(context: Context, parent: DivContainerTemplate?) -> DeserializationResult<DivContainer> {
    ...
    var errors = mergeErrors(
      ...
      layoutModeValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "layout_mode", error: $0) },
      lineSeparatorValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "line_separator", error: $0) },
      ...
      orientationValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "orientation", error: $0) },
      ...
      separatorValue.errorsOrWarnings?.map { .nestedObjectError(fieldName: "separator", error: $0) },
  ...
  public static func resolveValue(context: Context, parent: DivContainerTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivContainer> {
    if useOnlyLinks {
      return resolveOnlyLinks(context: context, parent: parent)
    }
