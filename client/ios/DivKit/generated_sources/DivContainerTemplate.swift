    ...
    public static func resolveValue(context: TemplatesContext, parent: SeparatorTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivContainer.Separator> {
      ...
      _ = {
        ...
        for (key, __dictValue) in context.templateData {
          ...
          _ = {
           if key == parent?.showAtEnd?.link, context.templateData["show_at_end"] == nil {
             showAtEndValue = deserialize(__dictValue).orFallback(showAtEndValue)
            }
          }()
          _ = {
           if key == parent?.showAtStart?.link, context.templateData["show_at_start"] == nil {
             showAtStartValue = deserialize(__dictValue).orFallback(showAtStartValue)
            }
          }()
          _ = {
           if key == parent?.showBetween?.link, context.templateData["show_between"] == nil {
             showBetweenValue = deserialize(__dictValue).orFallback(showBetweenValue)
            }
          }()
          _ = {
           if key == parent?.style?.link, context.templateData["style"] == nil {
             styleValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivDrawableTemplate.self).orFallback(styleValue)
            }
          }()
        }
      }()
  ...
  public static func resolveValue(context: TemplatesContext, parent: DivContainerTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivContainer> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.clipToBounds?.link, context.templateData["clip_to_bounds"] == nil {
           clipToBoundsValue = deserialize(__dictValue).orFallback(clipToBoundsValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.layoutMode?.link, context.templateData["layout_mode"] == nil {
           layoutModeValue = deserialize(__dictValue).orFallback(layoutModeValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.lineSeparator?.link, context.templateData["line_separator"] == nil {
           lineSeparatorValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivContainerTemplate.SeparatorTemplate.self).orFallback(lineSeparatorValue)
          }
        }()
        _ = {
         if key == parent?.lineSpacing?.link, context.templateData["line_spacing"] == nil {
           lineSpacingValue = deserialize(__dictValue, validator: ResolvedValue.lineSpacingValidator).orFallback(lineSpacingValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.separator?.link, context.templateData["separator"] == nil {
           separatorValue = deserialize(__dictValue, templates: context.templates, templateToType: context.templateToType, type: DivContainerTemplate.SeparatorTemplate.self).orFallback(separatorValue)
          }
        }()
        _ = {
