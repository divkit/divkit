...
public final class DivContainerTemplate: TemplateValue, TemplateDeserializable {
  ...
  public convenience init(dictionary: [String: Any], templateToType: TemplateToType) throws {
    do {
      ...
      throw DeserializationError.invalidFieldRepresentation(
        field: "div-container_template." + field,
        representation: representation
      )
    }
  }
  ...
  private static func resolveOnlyLinks(
    context: Context,
    parent: DivContainerTemplate?
  ) -> DeserializationResult<DivContainer> {
  ...
  public static func resolveValue(
    ...
    var orientationValue: DeserializationResult<Expression<DivContainer.Orientation>> = parent?
  ...
  private func mergedWithParent(templates: Templates) throws -> DivContainerTemplate {
  ...
  public func resolveParent(templates: Templates) throws -> DivContainerTemplate {
