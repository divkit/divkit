  ...
  public static func resolveValue(context: TemplatesContext, parent: DivSwitchTemplate?, useOnlyLinks: Bool) -> DeserializationResult<DivSwitch> {
    ...
    _ = {
      ...
      for (key, __dictValue) in context.templateData {
        ...
        _ = {
         if key == parent?.isOnVariable?.link, context.templateData["is_on_variable"] == nil {
           isOnVariableValue = deserialize(__dictValue).orFallback(isOnVariableValue)
          }
        }()
        _ = {
        ...
        _ = {
         if key == parent?.onColor?.link, context.templateData["on_color"] == nil {
           onColorValue = deserialize(__dictValue, transform: Color.color(withHexString:)).orFallback(onColorValue)
          }
        }()
        _ = {
